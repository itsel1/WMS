...
public class ProcessedPickup  implements java.io.Serializable {
    ...
    private net.aramex.ws.ShippingAPI.v1.ProcessedShipment[] processedShipments;
    ...
    public ProcessedPickup(
           ...
           net.aramex.ws.ShippingAPI.v1.ProcessedShipment[] processedShipments) {
           this.ID = ID;
           this.GUID = GUID;
     ...
     */
    public net.aramex.ws.ShippingAPI.v1.ProcessedShipment[] getProcessedShipments() {
        return processedShipments;
    }
     ...
     */
    public void setProcessedShipments(net.aramex.ws.ShippingAPI.v1.ProcessedShipment[] processedShipments) {
        this.processedShipments = processedShipments;
    }
