...
public class ProcessedShipmentAttachment  implements java.io.Serializable {
    ...
    private net.aramex.ws.ShippingAPI.v1.ProcessedShipmentAttachmentType type;
    ...
    public ProcessedShipmentAttachment(
           ...
           net.aramex.ws.ShippingAPI.v1.ProcessedShipmentAttachmentType type,
     ...
     * @return type
     */
    public net.aramex.ws.ShippingAPI.v1.ProcessedShipmentAttachmentType getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(net.aramex.ws.ShippingAPI.v1.ProcessedShipmentAttachmentType type) {
        this.type = type;
    }
