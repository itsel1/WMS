...
public class TrackingService_1_0_ServiceLocator extends org.apache.axis.client.Service implements net.aramex.ws.ShippingTrackAPI.v1.TrackingService_1_0_Service {

    public TrackingService_1_0_ServiceLocator() {
    }


    public TrackingService_1_0_ServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public TrackingService_1_0_ServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public net.aramex.ws.ShippingTrackAPI.v1.TrackingService_1_0_PortType getBasicHttpBinding_Service_1_01() throws javax.xml.rpc.ServiceException {
    ...
    public net.aramex.ws.ShippingTrackAPI.v1.TrackingService_1_0_PortType getBasicHttpBinding_Service_1_01(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.aramex.ws.ShippingTrackAPI.v1.TrackingBasicHttpBinding_Service_1_01Stub _stub = new net.aramex.ws.ShippingTrackAPI.v1.TrackingBasicHttpBinding_Service_1_01Stub(portAddress, this);
    ...
    public net.aramex.ws.ShippingTrackAPI.v1.TrackingService_1_0_PortType getBasicHttpBinding_Service_1_0() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public net.aramex.ws.ShippingTrackAPI.v1.TrackingService_1_0_PortType getBasicHttpBinding_Service_1_0(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.aramex.ws.ShippingTrackAPI.v1.TrackingBasicHttpBinding_Service_1_0Stub _stub = new net.aramex.ws.ShippingTrackAPI.v1.TrackingBasicHttpBinding_Service_1_0Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.aramex.ws.ShippingTrackAPI.v1.TrackingService_1_0_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                net.aramex.ws.ShippingTrackAPI.v1.TrackingBasicHttpBinding_Service_1_01Stub _stub = new net.aramex.ws.ShippingTrackAPI.v1.TrackingBasicHttpBinding_Service_1_01Stub(new java.net.URL(BasicHttpBinding_Service_1_01_address), this);
                _stub.setPortName(getBasicHttpBinding_Service_1_01WSDDServiceName());
                return _stub;
            }
            if (net.aramex.ws.ShippingTrackAPI.v1.TrackingService_1_0_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                net.aramex.ws.ShippingTrackAPI.v1.TrackingBasicHttpBinding_Service_1_0Stub _stub = new net.aramex.ws.ShippingTrackAPI.v1.TrackingBasicHttpBinding_Service_1_0Stub(new java.net.URL(BasicHttpBinding_Service_1_0_address), this);
                _stub.setPortName(getBasicHttpBinding_Service_1_0WSDDServiceName());
                return _stub;
            }
        }
