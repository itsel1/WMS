...
public class ManagerVO2 {
	...
	private String userTelss;
	private String userAddrss;
	private String userAddrDetailss;
	private String userEmailss;
	private String userEAddrss;
	private String userEAddrDetailss;
	private String comNamess;
	private String comENamess;
	
	public String getUserTel() {
		String value = this.userTelss;
		try {
	...
	public String getUserAddrDetail() {
		String value = this.userAddrDetailss;
		try {
			value = AES256Cipher.AES_Encode(value, symmetryKey);
		} catch (InvalidKeyException | UnsupportedEncodingException | NoSuchAlgorithmException | NoSuchPaddingException
				| InvalidAlgorithmParameterException | IllegalBlockSizeException | BadPaddingException e) {
	...
	public String getUserEAddrDetail() {
		String value = this.userEAddrDetailss;
		try {
			value = AES256Cipher.AES_Encode(value, symmetryKey);
		} catch (InvalidKeyException | UnsupportedEncodingException | NoSuchAlgorithmException | NoSuchPaddingException
				| InvalidAlgorithmParameterException | IllegalBlockSizeException | BadPaddingException e) {
	...
	public void settingAes() {
		setUserTel(userTel);
		setUserAddr(userAddr);
		setUserAddrDetail(userAddrDetail);
		setUserEmail(userEmail);
		setUserEAddr(userEAddr);
		setUserEAddrDetail(userEAddrDetail);
		setComName(comName);
		setComEName(comEName);
	}
}
