...
<body class="no-skin">
	<div class="site-wrap">
		...
		<div class="toppn">
			<div class="container">
				<div class="row">
					<div class="col-md-12 mb-0" style="font-size:14px !important;"><a>재고관리</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">반품 및 폐기 리스트</strong></div>
				</div>
			</div>
		</div>
		<div class="container">
			<div class="page-content noneArea">
				...
				<div class="col-xs-12 col-sm-12" id="inner-content-side">
					<div id="search-div">
						<br>
						<form class="hidden-xs hidden-sm" id="dtSearchForm" method="post" action= "/cstmr/stock/inspcUserDisposalStock">
					...
					<div id="table-contents" class="table-contents" style="width:100%; overflow: auto;">
						<div class="display" style="width:1920px">
							...
							<tbody>
								<c:forEach items="${inspStockList}" var="inspStockInfo" varStatus="status">
										<tr>
											...
											<td style="padding:0px;width:80px;text-align:center;vertical-align:middle;">
