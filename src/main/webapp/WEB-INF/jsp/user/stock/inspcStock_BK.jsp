									...
									<table id="dynamic-table" class="table table-bordered table-dark">
										...
										<tbody>
											<c:forEach items="${inspStockList}" var="inspStockInfo" varStatus="status">
												...
												<c:forEach items="${inspStockInfo.inspStockVO}" var="inspStockVO" varStatus="inspStatus">
													<tr >
														<td id="checkboxTd${inspStockVO.stockNo}" name="checkboxTd" class="center" style="word-break:break-all;width:20px;">
															<label class="pos-rel">
														...
														<td class="center">
															<span>
																<img src="${inspStockVO.itemImgUrl}" width="100"/>
															</span>
														</td>
															...
															<div class="col-xs-12 col-sm-12">
																<div class="profile-user-info profile-user-info-striped">
																	...
																	<div class="profile-info-row">
																		...
																		<div class="profile-info-value">
																			<span>${inspStockVO.whStatusName}</span>
																		</div>
																	</div>
																	...
																	<div class="profile-info-row">
																		...
																		<div class="profile-info-value">
																			<span>${inspStockVO.whCnt} / ${inspStockVO.totalWhCnt}</span>
																		</div>
																	</div>
																</div>
															</div>
														...
														<td class="center" style="width:150px">
															<span>
																${inspStockVO.trkCom}/${inspStockVO.trkNo}/${inspStockVO.stockNo}
															</span>
														</td>
														<td class="center" style="width:240px">
															<input type="text" readonly id="whMemo${inspStockVO.stockNo}" name="whMemo" value="${inspStockVO.whMemo}"/>
														</td>
														<td class="left" style="width:200px">
															<input type="text" id="userMsg${inspStockVO.stockNo}" name="userMsg" readonly value="${inspStockVO.userMsg}"/>
															<div style="text-align: right">
																<a href="javascript:fn_popupOpen('${inspStockVO.groupIdx}','${inspStockVO.nno}','${inspStockVO.subNo}')">History</a>
															</div>
															<input type="text" id="adminMsg${inspStockVO.stockNo}" name="adminMsg" value="${inspStockVO.adminMsg}"/>
														</td>
														<td class="center" style="width:220px">
															<span>
																<c:forEach items="${inspStockVO.filePath}" var="filePath" varStatus="status">
																	<a href="/image/stock/${inspStockVO.nno}/${filePath}" target="_blank">
																		<img src="/image/stock/${inspStockVO.nno}/${filePath}" style="width:150px">
																	</a> 
																</c:forEach>
															</span>
														</td>
														<td class="center padding0" style="width:120px">
															<div>
																...
																<button type="button" onclick="javascript:fn_returnInsp('${inspStockVO.groupIdx}','${inspStockVO.stockNo}')" class="btn btn-white btn-xs btn-danger" style="margin:2px">입고 취소</button><br/>
																<button type="button" onclick="javascript:fn_pdfPopup('${inspStockVO.groupIdx}','${inspStockVO.nno}')"class="btn btn-white btn-xs btn-primary" style="margin:2px;">재고번호 출력</button>
															</div>
														</td>
													</tr> 
												</c:forEach>
