	...
	<body>
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="toppn">
						<div class="container">
							<div class="row">
								<div class="col-md-12 mb-0" style="font-size:14px !important;"><a>검품배송 신청서</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">검품배송 단일 신청</strong></div>
							</div>
						</div>
					</div>
						<div class="container">
		...
		<script type="text/javascript">
			...
			/* $("#totals").on("change", function(){
				...
				$.ajax({
					url:'/cstmr/apply/insp/registOne',
					type: 'GET',
					beforeSend : function(xhr)
					{   
					    xhr.setRequestHeader("${_csrf.headerName}", "${_csrf.token}");
