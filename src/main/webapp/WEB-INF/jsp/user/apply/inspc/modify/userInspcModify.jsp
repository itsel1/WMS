			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="toppn">
						<div class="container">
							<div class="row">
								<div class="col-md-12 mb-0" style="font-size:14px !important;"><a>배송대행 신청</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">검품배송 신청서 수정</strong></div>
							</div>
						</div>
					</div>
						<div class="container">
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				$(document).ready(function() {
					...
					/* $("#transCodeList").val($("#transCode").val());
					$("#transCodeList").trigger('change'); */
