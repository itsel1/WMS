											...
											<div class="col-xs-12 col-md-2 form-group">
												<select id="dstnNation" name="dstnNation" style="height: 34px; width: 100%;">
													<c:forEach items="${transComList}" var="transCom" varStatus="status">
														<c:if test = "${transCom.transCode eq 'ARA'}">
															<option value="${transCom.transCode}" <c:if test="${transCom.transCode eq selDstn}">selected</c:if>>${transCom.transName}</option>
														</c:if>
														<c:if test = "${transCom.transCode eq 'YES'}">
															<option value="${transCom.transCode}" <c:if test="${transCom.transCode eq selDstn}">selected</c:if>>${transCom.transName}</option>
														</c:if>
														<c:if test = "${transCom.transCode eq 'YSL'}">
															<option value="${transCom.transCode}" <c:if test="${transCom.transCode eq selDstn}">selected</c:if>>${transCom.transName}</option>
														</c:if>
														
													</c:forEach>
													<!-- <option value="ARA" selected>ARAMEX</option> -->
												</select>
											</div>
																...
																<td class="center colorBlack no-padding">
																	<div class="row no-padding" style="background-color: rgba(255,255,255,0) !important;border-top:1px solid black; border-bottom:1px solid #e0e0e0; display: flex;">
																		...
																		<div class="col-xs-10 no-padding">
																			...
																			<div class="row rightBorder no-padding" style="text-align:left; rgba(255,255,255,0) !important;border-top:1px solid #e0e0e0;border-bottom:none; display: flex;">
																				<div class="col-xs-12">
																					<c:forEach items="${inspAllList.value}" var="inspList" varStatus="status">
												...
												<%-- <table id="dynamic-table" class="table table-bordered table-hover containerTable">
													...
													<thead>
														<tr>
															...
															<th class="center colorBlack">출발지/도착지</th>
															<th class="center colorBlack">
																주문 일자
															</th>
															<th class="center colorBlack">
													...
													<tbody>
														<c:forEach items="${inspList}" var="inspAllList" varStatus="status">
															<tr	>
																...
																<td class="center colorBlack" >
																	<div class="row" style="background-color: rgba(255,255,255,0) !important;">
																		<div class="col-xs-12">
																			${inspAllList.value[0].cneeAddr} ${inspAllList.value[0].cneeAddrDetail}
																		</div>
																	</div>
																	<br>
																	<div class="row" style="background-color: rgba(255,255,255,0) !important;border-bottom:1px solid black;">
																		<div class="col-xs-2" >
																			HSCODE
																		</div>
																		<div class="col-xs-4" >
																	...
																	<c:forEach items="${inspAllList.value}" var="inspList" varStatus="status">
																		<div class="row" style="background-color: rgba(255,255,255,0) !important;border-bottom:1px solid #e0e0e0;">
																			<div class="col-xs-2" >
																				${inspList.hsCode} 
																			</div>
																			<div class="col-xs-4" >
																	...
																	<div class="row" style="background-color: rgba(255,255,255,0) !important;border-top:1px solid black;border-bottom:none;">
			...
			jQuery(function($) {
				...
				$('#rgstrCheck').on('click',function(e){
					...
					$('#dynamic-table').find('tbody > tr > td input[type=checkbox]').each(function(){
						...
						if(td_checked){
							if(row.lastElementChild.lastElementChild.lastElementChild.lastElementChild.lastElementChild.childElementCount == 0){
