...
<html>
	...
	<body class="no-skin">
		...
		<div class="toppn">
	      <div class="container">
	        <div class="row">
	          <div class="col-md-12 mb-0" style="font-size:14px !important;"><a>등록내역</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">발송 대기</strong></div>
	        </div>
	      </div>
	    </div>
	    <!-- Main container Start-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				$('#formSelect').on('change', function(){
					location.href="/cstmr/apply/shpngSendBefore?transCode="+$(this).val();
				});
				...
				$('#delCheck').on('click',function(e){
					...
					$.ajax({
						...
						success : function(data) {
							if(data == "S"){
								alert("삭제 되었습니다.")
								location.href="/cstmr/apply/shpngSendBefore?transCode=ACI";
							}else if(data == "F"){
