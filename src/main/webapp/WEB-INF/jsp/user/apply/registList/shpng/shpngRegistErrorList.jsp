							...
							<div class="form-group">
								<div class="row">
									<div class="col-xs-12 col-md-2 form-group">
										<select class="chosen-select-start tag-input-style width-100 pd-1rem nations" id="transCode" name="transCode">
											...
											<c:forEach items="${userDstnNation}" var="userDstnNation">
												<option value="${userDstnNation.transCode}"<c:if test="${userDstnNation.transCode eq transCode }"> selected </c:if>>${userDstnNation.nationCode}</option>
											</c:forEach>
										</select>
