									...
									<div class="form-group">
										<div class="col-xs-12 col-md-3 form-group">
											<select id="formSelect" style="height: 34px;width:100%;">
												...
												<option selected value="ARA">ARAMEX</option>
												<option value="YES">YESG2M</option>
												<option value="YSL">YOUNGSUNG</option>
											</select>
										</div>
															...
															<div class="row no-padding" style="background-color: rgba(255,255,255,0) !important;border-top:1px solid black; border-bottom:1px solid #e0e0e0; display: flex;">
																...
																<div class="col-xs-9 no-padding">
																	<div class="row rightBorder no-padding" style="background-color: rgba(255,255,255,0) !important; border-bottom:1px solid #e0e0e0; display: flex;">
																		<div class="col-xs-2 ">
																			<a href="/cstmr/apply/modifyRegistInfoInsp?types=insp&nno=${inspAllList.value[0].nno}">${inspAllList.value[0].orderNo}</a><br/>
																			<a href="/cstmr/apply/modifyRegistInfoInsp?types=insp&nno=${inspAllList.value[0].nno}">${inspAllList.value[0].hawbNo}</a>
																		</div>
																		<div class="col-xs-2">
				...
				$('#delCheck').on('click',function(e){
					...
					$.ajax({
						...
						success : function(data) {
							if(data == "S"){
								alert("삭제 되었습니다.")
								location.href="/cstmr/apply/inspRegistList?transCode=ARA";
							}else if(data == "F"){
