									...
									<div class="space-20"></div>
										<table id="dynamic-table" class="table table-bordered table-hover containerTable">
											<thead>
												...
												<th class="center colorBlack">운송장 번호</th>
											...
											<tbody>
												<c:forEach items="${shpngList}" var="shpngAllList" varStatus="status">
													<tr>
														...
														<td class="center colorBlack" >
															<a href="/cstmr/apply/modifyRegistShpng?types=shpng&nno=${shpngAllList.value[0].nno}">${shpngAllList.value[0].orderNo}</a>
														</td>
														<td class="center colorBlack" >
				...
				$('#delCheck').on('click',function(e){
					...
					$.ajax({
						...
						success : function(data) {
							if(data == "S"){
								alert("삭제 되었습니다.")
								location.href="/cstmr/apply/shpngRegistList?transCode=ACI";
							}else if(data == "F"){
