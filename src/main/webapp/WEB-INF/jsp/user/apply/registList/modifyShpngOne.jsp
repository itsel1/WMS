			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="toppn">
						<div class="container">
							<div class="row">
								<div class="col-md-12 mb-0" style="font-size:14px !important;"><a>등록내역</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">BL 프린트 수정</strong></div>
							</div>
						</div>
					</div>
						<div class="container">
								...
								<div class="row hr-8">
									...
									<div class="col-xs-3 center">
										<c:forEach items="${userOrgStation}" var="orgStationList">
											<c:if test="${userOrder.orgStation eq orgStationList.stationCode}">
												<input style="width:100%;" readOnly type="text" id="orgStationName" name="orgStationName" value="${orgStationList.stationName}">
									...
									<div class="col-xs-3 center">
										<c:forEach items="${userDstnNation}" var="dstnNationList">
											<c:if test="${fn:trim(userOrder.dstnNation) eq fn:trim(dstnNationList.dstnNation)}">
												<input style="width:100%;" readOnly type="text" id="orgStationName" name="orgStationName" value="${dstnNationList.nationName}">
									...
									<div class="col-xs-3 center">
										<input type="text" style="width:100%;" readOnly id="selectTrans" name="selectTrans" value="${userOrder.transName}">
										<input type="hidden"  id="transCode" name="transCode" value="${userOrder.transCode}">
									</div>
								</div>
