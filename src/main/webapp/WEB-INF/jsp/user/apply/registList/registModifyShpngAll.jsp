			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="toppn">
						<div class="container">
							<div class="row">
								<div class="col-md-12 mb-0" style="font-size:14px !important;"><a>등록내역</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">BL 프린트 확인</strong></div>
							</div>
						</div>
					</div>
						<div class="container">
							...
							<div class="page-content">
								...
								<div class="row hr-8">
									...
									<div class="col-xs-2 center">
										...
										<select class="form-control shipperVal" disabled id="transCodeList" name="transCodeList">
											<option value=""></option>
											<%-- <c:forEach items="${userDstnNation}" var="transCom">
												<option value="${transCom.transCode }"<c:if test= "${fn:trim(transCom.transCode) eq fn:trim(transCode)}">selected</c:if>>${transCom.nationCode}</option>
											</c:forEach> --%>
										</select>
									</div>
									<div class="col-xs-1 center mp07">
									...
									<div class="col-xs-2 center">
										<input type="text" style="width:100%;" id="payment" name="payment" value="${userOrder.payment}"/>
									</div> 
											...
											<div class="col-xs-12 col-lg-12" style="border: 1px solid #dee2e6!important; padding: 3rem!important">
												<div class="col-xs-12 col-lg-12 " style="font-size: 3;">
													...
													<c:if test="${(!empty expressOrderVO.shipperTaxNoYnExpress) or (!empty expressOrderVO.shipperTaxTypeYnExpress)}">
														...
														<c:if test="${!empty expressOrderVO.shipperTaxTypeYnExpress}">
															...
															<div class="col-xs-3">
																<select class="chosen-select-one form-control tag-input-style width-100 pd-1rem <c:if test="${!empty optionOrderVO.shipperTaxTypeYn}"> shipperVal </c:if>" id="shipperTaxType" name="shipperTaxType" disabled>
													...
													<c:if test="${(!empty expressOrderVO.cneeTaxTypeYnExpress) or (!empty expressOrderVO.cneeTaxNoYnExpress)}">
														<div class="row hr-8">
															<c:if test="${!empty expressOrderVO.cneeTaxTypeYnExpress}">
																...
																<div class="col-xs-3">
																	<select class="chosen-select-one form-control tag-input-style width-100 pd-1rem <c:if test="${!empty optionOrderVO.cneeTaxTypeYn}"> cneeVal </c:if>" id="cneeTaxType" name="cneeTaxType" disabled>
																		<c:forEach items="${taxTypeList}" var="taxTypeList">
												...
												<div class="col-xs-12 col-lg-12 " style="font-size: 3;">
													...
													<c:if test="${(!empty expressOrderVO.orderNoYnExpress) or (!empty expressOrderVO.orderDateYnExpress) or (!empty expressOrderVO.buySiteYnExpress) or (!empty expressOrderVO.getBuyYnExpress)}">
														...
														<c:if test="${!empty expressOrderVO.orderNoYnExpress}">
															...
															<div class="col-xs-2 center">
																<input class="col-xs-12 <c:if test="${!empty optionOrderVO.orderNoYn}"> orderVal </c:if>" type="text" name="orderNo" id="orderNo" value="${userOrder.orderNo}" readonly/>
															</div>
														</c:if>
													...
													<c:if test="${(!empty expressOrderVO.declTypeYnExpress) or (!empty expressOrderVO.foodYnExpress) or (!empty expressOrderVO.cosmeticYnExpress) or (!empty expressOrderVO.signYnExpress)}">
														...
														<c:if test="${!empty expressOrderVO.declTypeYnExpress}">
															...
															<div class="col-xs-2 center">
																<select class="col-xs-12 <c:if test="${!empty optionOrderVO.declTypeYn}"> orderVal </c:if> " id="declType" name="declType" disabled>
														...
														<c:if test="${!empty expressOrderVO.foodYnExpress}">
															...
															<div class="col-xs-2 center">
																<select class="col-xs-12 <c:if test="${!empty optionOrderVO.foodYn}"> orderVal </c:if>" id="food" name="food" disabled>
														...
														<c:if test="${!empty expressOrderVO.cosmeticYnExpress}">
															...
															<div class="col-xs-2 center">
																<select class="col-xs-12 <c:if test="${!empty optionOrderVO.cosmeticYn}"> orderVal </c:if>" id="cosmetic" name="cosmetic" disabled>
														...
														<c:if test="${!empty expressOrderVO.signYnExpress}">
															...
															<div class="col-xs-2 center">
																<select class="col-xs-12 <c:if test="${!empty optionOrderVO.signYn}"> orderVal </c:if>" id="sign" name="sign" disabled>
													...
													<c:if test="${(!empty expressOrderVO.userHeightYnExpress) or (!empty expressOrderVO.userLengthYnExpress) or (!empty expressOrderVO.userWidthYnExpress) or (!empty expressOrderVO.dimUnitYnExpress)}">
														...
														<c:if test="${!empty expressOrderVO.dimUnitYnExpress}">
															...
															<div class="col-xs-2 center">
																<select class="col-xs-12 volumeWeight <c:if test="${!empty optionOrderVO.dimUnitYn}"> orderVal </c:if>" id="dimUnit" name="dimUnit"  disabled>
													...
													<c:if test="${(!empty expressOrderVO.userWtaYnExpress) or (!empty expressOrderVO.userWtcYnExpress) or (!empty expressOrderVO.boxCntYnExpress) or (!empty expressOrderVO.wtUnitYnExpress)}"> 
														...
														<c:if test="${!empty expressOrderVO.wtUnitYnExpress}">
															...
															<div class="col-xs-2 center">
																<select class="col-xs-12 <c:if test="${!empty optionOrderVO.wtUnitYn}"> orderVal </c:if>" id="wtUnit" name="wtUnit" disabled>
												...
												<div class="col-xs-12 col-lg-12 " style="font-size: 3;">
													...
													<div class="row hr-8">
														...
														<div class="col-xs-2 center">
															<select class="col-xs-12 orderVal" id="expType" name="expType" disabled>
															...
															<div class="panel-collapse collapse multi-collapse in" id="collapseOne">
																<div class="panel-body">
																	...
																	<div class="col-md-6 col-xs-12 hr-8">
																		...
																		<div class="col-md-9 col-xs-12">
																			<input class="width-100 checkItem <c:if test="${!empty optionItemVO.itemUserWtaYn}"> itemVal </c:if>" type="text" name="itemUserYn" id="itemUserYn1" value="${orderItem.userWta}" />
																		</div>
																	</div>
																	<%-- <c:if test="${!empty expressItemVO.hsCodeYnExpress}">	
																		<div class="col-md-6 col-xs-12 hr-8">
										...
										<div class="col-lg-12 col-xs-12">
											...
											<div id="button-div">
												<div id="backPage" style="text-align: center">
													<button id="backToList" type="button" class="btn btn-sm btn-danger">확인</button>
												</div>
											</div>
											<br />
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				$(document).ready(function() {
					...
					/* if($("#urlType").val() == "before" || $("#urlType").val() == "after"){
						$("input").attr("readonly","true");
						$("#addBtns").hide();
						$("#delBtns").hide();
					}
					if($("#transCode").val() == 'FED'){
						$("input").attr("readonly","true");
						$("#addBtns").hide();
						$("#delBtns").hide();
					}
					if($("#transCode").val() == 'FEG'){
						$("input").attr("readonly","true");
						$("#addBtns").hide();
						$("#delBtns").hide();
					}
					if($("#transCode").val() == 'FES'){
						$("input").attr("readonly","true");
						$("#addBtns").hide();
						$("#delBtns").hide();
					} */
			...
			$('#backToList').on('click', function(e){
				if($("#urlType").val() == 'allAbout')
					location.href = "/cstmr/apply/shpngRegistList?transCode="+$("#transCode").val()
				else if($("#urlType").val() == 'before')
					location.href = "/cstmr/apply/shpngSendBefore?transCode="+$("#transCode").val()
				else if($("#urlType").val() == 'after')
					location.href = "/cstmr/apply/shpngSendAfter?transCode="+$("#transCode").val()
				else if($("#urlType").val() == 'error')
					location.href = "/cstmr/apply/shpngRegistErrorList?transCode="+$("#transCode").val()
			});
					...
					success : function(data) {
						...
						if(data.transComList.length == 0){
							...
							for(var i = 0; i < data.transComList.length; i++){
								if($("#transCode").val() == data.transComList[i].transCode){
					...
					$.ajax({
						...
						success : function(data) {
							if(data == "S"){
								...
								alert("수정 되었습니다.");
								location.href="/cstmr/apply/shpngRegistList";
							}else{
								$(".checkItem").each(function(e){
									if(!$(this).hasClass("itemVal")){
										if($(this).val() == "d#none#b"){
