												...
												<div class="col-xs-12 col-lg-12 form-group" style="font-size: 3;">
													...
													<div class="profile-user-info  form-group hr-8">
														...
														<div class="profile-info-value">
															<input class="col-xs-12 shipperVal" type="text" name="shipperName" id="shipperName" value="${userInfo.comName}" />
														</div>
												...
												<div class="col-xs-12 col-lg-12 form-group" style="font-size: 3;">
													...
													<div class="profile-user-info  form-group hr-8">
														...
														<div class="profile-info-value">
															<div class="col-xs-12">
																<div class="input-group input-group-sm">
																	...
																	<input type="text"  id="orderDate" name="orderDate" class="col-xs-12" value="${userOrder.orderDate}"/>
																</div>
															</div>
														...
														<div class="profile-info-value" style="vertical-align: middle;">
															...
															<%-- <input class="col-xs-12 orderVal"  type="text" name="chgCurrency" id="chgCurrency${status.count}" value="${userOrderItem[0].chgCurrency}" /> --%>
														</div>
													</div>
