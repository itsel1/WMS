		...
		<div class="col-xs-12 col-lg-12" style="border: 1px solid #dee2e6!important; padding: 3rem!important">
			<div class="col-xs-12 col-lg-12 " style="font-size: 3;">
				...
				<div class="row hr-8">
					...
					<div class="col-xs-3">
						<input class="col-xs-12" type="text" name="userEmail" id="userEmail" value="${userInfo.userEmail}" />
					</div>
				</div>
			</div>
			<div class="col-xs-12 col-lg-12 " style="font-size: 3;">
			...
			<div class="col-xs-12 col-lg-12 " style="font-size: 3;">
					...
					<div class="col-xs-3 center">
						<div class="col-lg-12">
							<div class="input-group input-group-sm">
								...
								<input type="text" id="orderDate" name name="orderDate" class="form-control" value="${userOrder.orderDate}"/>
							</div>
						</div>
				...
				<div class="row hr-8">
					...
					<div class="col-xs-2 center">
						<select class="col-xs-12 orderVal volumeWeight" id="dimUnit" name="dimUnit" >
								...
								<div class="col-md-6 col-xs-12">
									...
									<div class="col-md-9 col-xs-12">
										<div class="input-group input-group-sm">
											...
											<input type="text" id="trkDate1" dateChk name="trkDate" onclick="javascript:test(this);" class="form-control"/>
										</div>
									</div>
								</div>
							</div>
		...
		<script type="text/javascript">
			...
			$('#rgstrInfo').on('click',function(e){
				...
				$(".shipperVal").each(function(e){
					if($(this).val() == ""){
						alert("발송 정보의 "+$($(".shipperNm").get(e)).text().trim()+"을 확인해 주세요.");
						$(this).focus();
						valiChk = 1;
						return false;
					}
				...
				$("input:text[dateChk]").forEach(function(e){
