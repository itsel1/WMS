...
<body class="no-skin">
						...
						<td class="center colorBlack no-padding">
							...
							<div class="row rightBorder no-padding" style="background-color: rgba(255,255,255,0) !important; border-bottom:1px solid #e0e0e0; display: flex;">
								<div class="col-xs-2 no-padding">
									<a href="#" onClick="javascript:readModify('nomal','${shpngAllList.value[0].nno}'); return false;">${shpngAllList.value[0].orderNo}</a>
								</div>
								<div class="col-xs-1 no-padding" >
									...
									<input type="hidden" id="uploadType${status.index}" name="uploadType${status.index}" value="${shpngAllList.value[0].uploadType}">
								</div>
								<div class="col-xs-1 no-padding">
							...
							<div class="row rightBorder no-padding" style="background-color: rgba(255,255,255,0) !important; border-bottom:1px solid #e0e0e0; display: flex;">
								...
								<div class="col-xs-1 no-padding">
									<c:forEach items="${shpngAllList.value}" var="shpngList" varStatus="statusItem">
										${statusItem.count}<br />
									</c:forEach>
	...
	<script type="text/javascript">
			function readModify(type,nno){
				...
				$("#uploadForm").attr("action", "/cstmr/apply/modifyShpng");    ///board/modify/로
