							...
							<div class="col-xs-12 form-group" style="margin:0px;">
								<div class="row">
									<div class="col-xs-12 col-md-2 form-group">
										<select class="chosen-select-start form-control tag-input-style width-100 pd-1rem nations" id="totals" name="totals">
											<option value=""> Please choice area... </option>
										...
										<%-- <select id="dstnNation" name="dstnNation" style="height: 34px; width: 100%;">
											...
											<!-- <option value="ACI" selected>ACI</option> -->
										</select> --%>
									</div>
											...
											<c:forEach items="${shpngList}" var="shpngAllList" varStatus="status">
												<tr>
													...
													<%-- <c:if test="${!empty optionOrderVO.orderNoYn}">
														...
														<c:if test="${empty shpngAllList.value[0].orderNo}">
													...
													<c:forEach items="${shpngAllList.value}" var="shpngList" varStatus="status">
														...
														<c:if test="${shpngList.itemValue ne (shpngList.itemCnt * shpngList.unitValue)}">
