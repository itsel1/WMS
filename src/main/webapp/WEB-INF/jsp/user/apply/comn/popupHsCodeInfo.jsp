...
<html lang="en">
	...
	<body class="no-skin">
				...
				<div class="main-content-inner">
					...
					<%-- <div class="page-content">
						<div class="col-xs-12 col-sm-12" id="inner-content-side">
							<select class="chosen-select-start" id="hsCode" name="hsCode" style="width:100%;">
								<c:forEach items="${codeList}" var="codeList">
									<option value="${codeList.hsCode}">${codeList.hsCode}</option>
								</c:forEach>
							</select>
						</div>
					</div> --%>
		...
		<script type="text/javascript">
			...
			function fn_regHsCode(idx, hsCode, category, itemDetail, material, cnt) {
				opener.parent.fn_hsCodeIn(idx, hsCode, category, itemDetail, material, cnt);
				self.close();
			}
		</script>
	</body>
