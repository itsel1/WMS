	...
	<body>
								...
								<div class="tab-content">
									<form enctype="multipart/form-data" name="returnForm" id="returnForm" method="get" action="">
										...
										<div style="margin-left:10px;">
											<p style="font-size:20px; font-weight:bold; color:black;">배송 구분</p>
											<input type="radio" id="wms_info" name="send_type" value="A" checked><label for="wms_info">&nbsp;자사 배송 (WMS)</label>&nbsp;&nbsp;
											<input type="radio" id="other_info" name="send_type" value="B">&nbsp;<label for="other_info">타사 배송</label>
										</div>
										<br/>
										<div class="row hide" id="wms_input">
										...
										<div>
											<div class="row">
												<table class="station_table" style="margin-left:20px;">
													<thead>
														<tr>
															<c:if test="${empty nno}">
																<th style="font-size:18px; width:60px; text-align:center;">출발지</th>
																<td style="border:none; padding:0px; width:200px;">
																...
																<th style="font-size:18px; width:60px; text-align:center;">도착지</th>
																<td style="border:none; padding:0px; width:200px;">
												...
												<table class="table table-bordered" style="margin-left:20px; width:98%;">
													...
													<tbody>
														...
														<tr>
															...
															<td style="padding:0px;">
																<input type="text" style="width:100%;height:36px;" name="senderAddr" id="senderAddr" value="${rtn.senderAddr}"/>
															</td>
															<th class="center colorBlack" style="width:10%;"><font class="red" id="senderTel_ft">*&nbsp;</font>전화번호</th>
															<td style="padding:0px;">
																<input type="text" style="width:100%;height:36px;" numberOnly name="senderTel" id="senderTel" value="${rtn.senderTel}" placeholder="숫자만 입력 가능합니다."/>
															</td>
														</tr>
														<tr>
															<c:if test="${rtn.orgStation eq 'US'}">
												...
												<table class="table table-bordered" style="margin-left:20px; width:98%;">
													...
													<tbody>
														...
														<tr class="hideTax">
															...
															<td style="width:10%; background:white;"><input type="file" class="taxTypeValue" id="rtnReason" name="rtnReason" class=""></td>
															<td style="vertical-align: middle; background:white;">
														...
														<tr class="hideTax">
															...
															<td style="width:10%; background:white;"><input type="file" class="taxTypeValue" id="rtnCapture" name="rtnCapture" class=""></td>
															<td style="background:white;"></td>
														</tr>
														<tr class="hideTax">
															<th class="center colorBlack" style="width:12%;"><font class="red hide" id="rtnMessenger_ft">*&nbsp;</font>반품 메신저 캡쳐본</th>
															<td style="width:10%; background:white;"><input type="file" class="taxTypeValue" id="rtnMessenger" name="rtnMessenger" class=""></td>
															<td style="background:white;"></td>
														</tr>
														<tr class="hideTax">
															<th class="center colorBlack" style="width:12%;"><font class="red hide" id="rtnCl_ft">*&nbsp;</font>반품 Commercial Invoice</th>
															<td style="width:10%; background:white;"><input type="file" class="taxTypeValue" id="rtnCl" name="rtnCl" class=""></td>
															<td style="vertical-align: middle; background:white;">
														...
														<tr class="hideTax">
															...
															<td style="width:10%; background:white;"><input type="file" class="taxTypeValue" id="rtnCopyBank" name="rtnCopyBank" class=""></td>
															<td style="background:white;"></td>
														</tr>
																...
																<div class="col-xs-12 col-lg-12" style="border: 1px solid #dee2e6!important; padding: 3rem!important">
																	<div class="col-xs-12 col-lg-12" style="font-size: 3;">
																		...
																		<div class="row hr-8">
																			...
																			<div class="col-xs-1 center mp07">
																				<font class="red hide">*&nbsp;</font><label>상품명 (일문)</label>
																			</div>
																			<div class="col-xs-3">
											...
											<div class="row" style="text-align:center; margin-top: 20px;">
												<button class="registReturn" role="button" id="registReturn_aci"><span class="text">반품 접수</span></button>
											</div>
											<br/>
										</div>
									</form>
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				$('input[name="send_type"]').on('click', function() {
					if($(this).val() == 'A') {
						$("#wms_input").addClass('hide');
						$("#other_input").removeClass('hide');
					} else {
						$("#other_input").addClass('hide');
						$("#wms_input").removeClass('hide');
						$(".other_file").removeClass('hide');
					}
				})
				...
				$('input[name="taxType"]').on('click', function() {
					if($(this).val() == 'Y') {
						...
						$("#rtnReason").addClass('require');
						$("#rtnCapture").addClass('require');
						$("#rtnMessenger").addClass('require');
						$("#rtnCl").addClass('require');
						$("#rtnCopyBank").addClass('require');
					} else {
						...
						$("#rtnReason").removeClass('require');
						$("#rtnCapture").removeClass('require');
						$("#rtnMessenger").removeClass('require');
						$("#rtnCl").removeClass('require');
						$("#rtnCopyBank").removeClass('require');
					}
				})
			...
			function searchKobl() {
				...
				location.href='/return/registReturn?koblNo='+$("#koblNo").val();
			};
