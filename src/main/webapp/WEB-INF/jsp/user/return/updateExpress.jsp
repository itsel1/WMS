...
- 반품회수대행 서비스를 위한 당사자간(ACI의 서비스 위탁 업체) 원활한 의사소통 및 배송, 상담 등 거래여행을 위하여 관련된 정보를 필요 범위 내에서 거래 당사자에게 제공에 동의한 경우
								...
								<tr>
									<td>
										<p>
											<label for="agreement_check"> <input type="checkbox" checked id="agreement_check" name="agreement_check"> 
								...
								<div class="main_div">
									...
									<div class="row">
										...
										<table class="hawbTable">
											<tr>
												<td>
													 <label for="hawbNo"></label> <input type="text" name="koblNo" value="${koblNo}" id="koblNo" readonly>
									...
									<div class="infoDiv">
										...
										<table class="infoTable">
											...
											<tr>
												...
												<td><input type="text" class = "backYellow info_input" name="orderDate" id="orderDate" value="${rtn.orderDate }"></td>
											</tr>
											<tr>
												<td class="td_name">이름</td>
												...
												<td><input type="text" class = "backYellow info_input" name="pickupZip" id="pickupZip" value="${rtn.pickupZip }"></td>
											</tr>
											<tr>
												...
												<td title="영문주소는 수정이 불가능합니다."><input type="text" class = "backYellow info_input" name="pickupEngAddr" id="pickupEngAddr" value="${rtn.pickupEngAddr }" readonly></td>
											</tr>
											<tr>
												<td class="td_name">전화번호</td>
										...
										<table class="infoTable">
											...
											<tr>
												<td class="td_name">전화번호</td>
												<td><input type="text" class = "backYellow info_input" name="senderTel" id="senderTel" value="${rtn.senderTel }"></td>
											</tr>
											<%-- <tr>
												<td class="td_name">휴대전화번호</td>
									...
									<div style="text-align: left;">
										<a href="https://unipass.customs.go.kr/clip/index.do">HS CODE 조회 사이트 바로가기</a>
									</div>
									<div class="row">
