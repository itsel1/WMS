						...
						<table class="input-table">
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" name="shipperTel" id="shipperTel" onKeyup="this.value=this.value.replace(/[^-0-9]/g,'');" value="${orderList.shipperTel}"></td>
									<th>휴대전화번호</th>
									<td><input type="text" name="shipperHp" id="shipperHp" onKeyup="this.value=this.value.replace(/[^-0-9]/g,'');" value="${orderList.shipperHp}"></td>
								</tr>
							</tbody>
						</table>
						<table class="input-table">
							...
							<tbody>
								...
								<tr>
									...
									<th><font class="red">*</font> 전화번호</th>
									<td><input type="text" name="cneeTel" id="cneeTel" onKeyup="this.value=this.value.replace(/[^-0-9]/g,'');" value="${orderList.cneeTel}"></td>
								</tr>
							</tbody>
						</table>
						<br><br>
