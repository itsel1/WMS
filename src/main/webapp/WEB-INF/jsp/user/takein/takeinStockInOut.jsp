						...
						<div class="page-header noneArea">
							...
							<div id="inner-content-side" >
									...
									<div class="col-xs-12 form-group" style="margin:0px;">
											<div class="row">											
												<form id="condForm" action="/cstmr/takein/takeinStockInOut" method="get" enctype="multipart/form-data">
		...
		<script type="text/javascript">  
		    $(document).ready(function(e){
		    	$("#btnExcelDown").click(function() {
		    		$("#condForm").attr('action','/cstmr/takein/takeinStockInOutExcelDown');
		    		$("#condForm").submit();
		    		$("#condForm").attr('action','/cstmr/takein/takeinStockInOut');
		    	});
		    });
	    </script> 
