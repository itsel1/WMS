...
<html>
	...
	<body class="no-skin">
		...
		<div class="toppn">
	      <div class="container">
	        <div class="row">
	          <div class="col-md-12 mb-0" style="font-size:14px !important;"><a>사입 삭제 내역</a> <span class="mx-2 mb-0">/
	          </span> <strong class="text-black">사입 삭제 내역</strong></div>
	        </div>
	      </div>
	    </div>
	    <!-- Main container Start-->
						...
						<div class="page-header noneArea">
							...
							<div id="inner-content-side" >
									...
									<div class="col-xs-12 form-group" style="margin:0px;">
											<div class="row">											
												<form action="/cstmr/takein/takeinDelOrderList" method="get" enctype="multipart/form-data">
												<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
													<table  class="table table-bordered" style="max-width:800px;float:left;">
														<thead>
															<tr>
									...
									<div id="table-contents" class="table-contents" style="width:100%; overflow: auto;">
										...
										<div class="display" >
											...
											<div style="text-align:left;float:right">
												<input type="button" value="복구" id="btn_rec" class="btn-primary">
											</div>
												...
												<c:forEach items="${takeinList}" var="takeorderinfo" varStatus="status">
														<tr>
														 <td style="text-align: center">
															...
															<td style="overflow: auto;">
																<span>${takeorderinfo.DUserId}</span>
																<br>
																<span>${takeorderinfo.DDate}</span>
																<br>
																<span>${takeorderinfo.DUserIp}</span>
															</td>
														</tr>
														<tr>
															<td colspan=11 style="padding-left:10px;">
																<table  style="width:100%;">
																	...
																	<tr>
																		...
																		<td style="text-align:center;">${itemDetail.unitValue * itemCnt}</td>
	    ...
	    $(document).ready(function(){
		    ...
		    $("#btn_rec").click(function() {
		        ...
		        $("#list_form").attr('action','/cstmr/takein/takeinRec');
	            $("#list_form").submit();
		    });
