		...
		<div class="toppn">
	      <div class="container">
	        <div class="row">
	          ...
	          </span> <strong class="text-black">주문별 출고현황</strong></div>
	        </div>
	      </div>
	    </div>
	    <!-- Main container Start-->
						...
						<div class="page-header noneArea">
							...
							<div id="inner-content-side" >
									...
									<div class="col-xs-12 form-group" style="margin:0px;">
											<div class="row">											
												<form id="condForm" action="/cstmr/takein/takeinOrderStockOut" method="get" enctype="multipart/form-data">
													...
													<table  class="table table-bordered" style="max-width:1200px;float:left;">
														<thead>
															<tr>
																...
																<th style="width:100px;" class="center colorBlack">주문번호</th>
									...
									<div id="table-contents" class="table-contents" style="width:100%; overflow: auto;">
										<div class="display" >
											<form id="list_form" action="" method="post">
												<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
											<br>
											<table id="listTable" class="table table-bordered table-striped" Style="margin-top:10px;" >
												 ...
												 <c:forEach items="${listRst}" var="listRst" varStatus="status">
														<tr>
															 <c:if test="${listRst.subRow eq '1'}">
																 <td class="center" rowspan="${listRst.rowCnt}" style="vertical-align: middle">
																	${listRst.stationName}
																</td>
																<td class="center" rowspan="${listRst.rowCnt}" style="vertical-align: middle">
																	${listRst.outDate}
		  ...
		  <script type="text/javascript">  
		    $(document).ready(function(e){
		    	$("#btnExcelDown").click(function() {
		    		$("#condForm").attr('action','/cstmr/takein/takeinOrderStockOutExcelDown');
		    		$("#condForm").submit();
		    		$("#condForm").attr('action','/cstmr/takein/takeinOrderStockOut');
		    	});
		    });
	    </script> 
