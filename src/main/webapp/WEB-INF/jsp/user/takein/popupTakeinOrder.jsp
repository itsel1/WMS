									  	...
									  	<thead>
											...
											<tr>
												...
												<td style="padding:0px;width:200px;">
													<input id="text" name="userId" class="onlyEN" style="width:100%;" type="text" value="${userInfo.userId}" readonly>
												</td>
												<th colspan=2>
												</th>
											</tr>
											...
											<tr>
												...
												<td style="padding:0px;width:200px;" id="orgStationTd">
													...
													<datalist id="userOrgStation" name="userOrgStation">
														<c:forEach items="${userOrgStation}" var="userOrgStation" varStatus="status">
															<option value="${userOrgStation.orgStation}"
																<c:if test="${userOrgStation eq userOrgStation.orgStation}">selected</c:if>>${userOrgStation.orgStation}
														</c:forEach>
													</datalist>
												</td>
												...
												<td style="padding:0px;width:200px;vertical-align: middle" id="dstnNationTd">
													...
													<datalist id="nationList" name="nationList">
														<c:forEach items="${nationList}" var="nationList" varStatus="status">
															<option value="${nationList.dstnEName}"
																<c:if test="${nationList eq nationList.dstnEName}">selected</c:if>>${nationList.dstnEName}
														</c:forEach>
													</datalist>
												</td>
											</tr>
