...
<html>
   ...
   <body class="no-skin">
				...
				<div class="main-content-inner">
					<div class="page-content">
						<div class="page-header">
							<h1>
								<i class="ace-icon fa fa-home home-icon"> Home</i>
							</h1>
						</div>
						<br/>
						<div style="width:1500px;" class="chart_div">
							<%-- <div class="wrapper3">
								<div class="item" style="grid-column: 1 / 3; border: 1px solid #dcdcdc; border-radius: 20px; padding: 10px;">
									<span style="font-weight:bold; font-size:16px; margin-left:10px; margin-top:5px; margin-bottom:15px; cursor:pointer;" onclick="fn_toNoticeMenu()">
									공지사항&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i>
									</span>
									<div style="margin-top:25px; margin-left:10px;">
										<c:forEach items="${noticeInfo}" var="list" varStatus="status">
											<div class="row" style="margin:10px;">
												<div class="col-xs-10" onclick="fn_toNotice('${list.idx}')" style="cursor:pointer;">
													<label style="background:#FA8C8C; border:1px solid #FA8C8C; color:white; font-size:12px; padding-left:2px; padding-right:2px; margin-right:8px;">공지필독</label>&nbsp;&nbsp;${list.title}
												</div>
												<div class="col-xs-2">
													<label style="text-align: right;">${list.date}</label>
												</div>
											</div>
										</c:forEach>
									</div>
								</div>
								<div class="item" style="grid-column: 3 / 5; border: 1px solid #F0B6B6; border-radius: 20px; padding: 10px;">
									<span style="font-weight:bold; font-size:16px; margin-left:10px; margin-top:5px; margin-bottom:15px; cursor:pointer;" onclick="fn_toCsMenu()">
									문의 게시판&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i>
									</span>
									<div style="width:100%; height:100%; text-align:center; vertical-align:middle; padding-top:80px; color:#ccc;">
										현재 문의 내역이 없습니다
									</div>
								</div>
							</div> --%>
							<c:if test="${result eq 'S'}">
								<div id="inner-content-side" class="wrapper">
									<div class="item" style="border: 1px solid #FDE1B4; border-radius: 20px; padding: 10px; position:relative;">
									...
									<div class="item" style="border: 1px solid #E598BB; border-radius: 20px; padding: 10px; position:relative;">
							...
							<c:if test="${result eq 'F'}">
								<div class="none-wrapper">
									<div class="item" style="grid-column: 1 / 5; font-weight:bold;">
										${month}월 출고 내역이 없습니다
									</div>
								</div>
							</c:if>
		...
		<script type="text/javascript">
			...
			var backgroundColorList = ['#FF6384', '#4BC0C0', '#FF9F40', '#FFCD56', '#36A2EB', '#9966FF', '#FFFC66'];
			...
			function fn_toNoticeMenu() {
				location.href = '/mngr/board/ntc';
			}

			function fn_toCsMenu() {
				location.href = '/mngr/board/qstns';
			}

			function fn_toNotice(idx) {
