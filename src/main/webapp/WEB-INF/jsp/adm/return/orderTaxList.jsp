         ...
         <div class="main-content">
            <div class="main-content-inner">
               ...
               <div class="page-content">
                  ...
                  <form name="returnForm" id="returnForm" method="get" action="/mngr/return/taxReturnList">
					...
					<table class="table table-bordered table-hover" id="return-table">
						<thead>
							<tr>
								...
								<th style="width:6%;">반송사유서</th>
								<th style="width:6%;">반품접수<br>캡처본</th>
								<th style="width:6%;">반품메신저<br>캡처본</th>
								<th style="width:6%;">반품 커머셜<br>인보이스</th>
								<th style="width:6%;">환급통장<br>사본</th>
								<th style="width:6%;">수출신고<br>필증</th>
								<th style="width:6%;">담당자명</th>
								<th style="width:7%;">담당자 Tel</th>
								<th style="width:11%;">담당자 Email</th>
								...
								<c:when test="${!empty orderList}">
									<c:forEach items="${orderList}" var="orderList" varStatus="status">
										<tr>
											...
											<td class="align-middle"><a href="${orderList.fileReason}" target="_blank">[다운로드]</a></td>
											<td class="align-middle"><a href="${orderList.fileCapture}" target="_blank">[다운로드]</a></td>
											<td class="align-middle"><a href="${orderList.fileMessenger}" target="_blank">[다운로드]</a></td>
											<td class="align-middle"><a href="${orderList.fileComm}" target="_blank">[다운로드]</a></td>
											<td class="align-middle"><a href="${orderList.fileBank}" target="_blank">[다운로드]</a></td>
											<td class="align-middle"><a href="${orderList.fileLicense}" target="_blank">[다운로드]</a></td>
      ...
      <!-- excel upload 추가 -->
      	jQuery(function($) {
          	$(document).ready(function() {
				...
				$("#returnMenu-7").toggleClass('active');
            });
