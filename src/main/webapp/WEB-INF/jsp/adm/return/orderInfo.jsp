               ...
               <div class="page-content">
                  ...
                  <div>
					<form name="form" id="form" enctype="multipart/form-data">
			    		...
			    		<input type="hidden" id="state" value="${orderList.state}">
							...
							<table id="return-tbl2">
								...
								<tr style="border-bottom: 1px solid rgba(204, 204, 204, 0.19);">
									...
									<c:if test="${orderList.taxType eq 'Y'}">
										<td><a href="${fileList.fileReason}" download target="_blank">[파일 다운로드]</a></td>
									</c:if>
									<c:if test="${orderList.taxType eq 'N'}">
								...
								<tr style="border-bottom: 1px solid rgba(204, 204, 204, 0.19);">
									...
									<c:if test="${orderList.taxType eq 'Y'}">
										<td><a href="${fileList.fileCapture}" download target="_blank">[파일 다운로드]</a></td>
									</c:if>
								</tr>
								<tr style="border-bottom: 1px solid rgba(204, 204, 204, 0.19);">
									...
									<c:if test="${orderList.taxType eq 'Y'}">
										<td><a href="${fileList.fileMessenger}" download target="_blank">[파일 다운로드]</a></td>
									</c:if>
								</tr>
								<tr style="border-bottom: 1px solid rgba(204, 204, 204, 0.19);">
									...
									<c:if test="${orderList.taxType eq 'Y'}">
										<td><a href="${fileList.fileComm}" download target="_blank">[파일 다운로드]</a></td>
									</c:if>
									<c:if test="${orderList.taxType eq 'N'}">
								...
								<tr style="border-bottom: 1px solid rgba(204, 204, 204, 0.19);">
									...
									<c:if test="${orderList.taxType eq 'Y'}">
										<td><a href="${fileList.fileBank}" download target="_blank">[파일 다운로드]</a></td>
									</c:if>
								</tr>
								<tr style="border-bottom: 1px solid rgba(204, 204, 204, 0.19);">
									...
									<c:if test="${orderList.taxType eq 'Y'}">
										<td><a href="${fileList.fileLicense}" download target="_blank">[파일 다운로드]</a></td>
									</c:if>
								</tr>
							</table>
		...
		jQuery(function($) {
			...
			$("#registReturn").on('click', function() {
				...
				if (state != 'A000' || state != 'A001' || state != 'A002' || state != 'B001') {
					...
					$("#form").attr("action", "/mngr/return/orderUp");
