				...
				<div class="page-content">
					...
					<form name="returnForm" id="returnForm">
						<div class="row hr-8">
							...
							<div class="col-xs-1 center mp07">출발지</div>
							...
							<div class="col-xs-1 center mp07">도착지</div>
							<div class="col-xs-2 center">
							...
							<div class="col-xs-1 center mp07">택배 회사</div>
							<div class="col-xs-2 center">
								<input type="text" style="width: 100%;" id="transCode" name="transCode" value="${userOrder.transCode}" readonly>
							</div>
							<div class="col-xs-1 center mp07">관세 지급 방식</div>
							<div class="col-xs-2 center">
						...
						<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> <input type="hidden" id="cnt" name="cnt" value="" /> <input type="hidden" name="hawbNo" id="hawbNo" value="${userOrder.hawbNo}" /> <input type="hidden" name="nno" id="nno" value="${userOrder.nno }" /> <input type="hidden" name="userId" id="userId" value="${userId}" />
								...
								<div class="col-xs-12 col-lg-12">
									...
									<div class="col-xs-12 col-lg-12" style="border: 1px solid #dee2e6 !important; padding: 3rem !important">
												...
												<div class="row hr-8">
													...
													<c:if test="${!empty expressOrderVO.customsNoYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.customsNoYn}"> cneeNm </c:if>">
															<label> <c:if test="${userOrder.dstnNation eq  'KR'}">
																		개인통관부호
																	</c:if> <c:if test="${userOrder.dstnNation ne  'KR'}">
																		수취인 ID 번호
																	</c:if>
															</label>
														</div>
											...
											<c:if test="${(!empty expressOrderVO.orderNoYnExpress) or (!empty expressOrderVO.orderDateYnExpress) or (!empty expressOrderVO.buySiteYnExpress) or (!empty expressOrderVO.getBuyYnExpress)}">
												<div class="row hr-8">
													<c:if test="${!empty expressOrderVO.orderNoYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.orderNoYn}"> orderNm </c:if>">주문 번호</div>
														<div class="col-xs-2 center">
													...
													<c:if test="${!empty expressOrderVO.orderDateYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.orderDateYn}"> orderNm </c:if>">주문 날짜</div>
														<div class="col-xs-2 center">
															<div class="col-lg-12">
																<div class="input-group input-group-sm">
																	<span class="input-group-addon"> <i class="ace-icon fa fa-calendar"></i>
																	</span> <input type="text" id="orderDate" name="orderDate" class="form-control <c:if test="${!empty optionOrderVO.orderDateYn}"> orderVal </c:if>" value="${userOrder.orderDate}" />
																</div>
															</div>
														</div>
													</c:if>
													<c:if test="${!empty expressOrderVO.buySiteYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.buySiteYn}"> orderNm </c:if>">구매 사이트</div>
														<div class="col-xs-2 center">
													...
													<c:if test="${!empty expressOrderVO.getBuyYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.getBuyYn}"> orderNm </c:if>">사용 용도</div>
														<div class="col-xs-2 center">
											...
											<c:if test="${(!empty expressOrderVO.userHeightYnExpress) or (!empty expressOrderVO.userLengthYnExpress) or (!empty expressOrderVO.userWidthYnExpress) or (!empty expressOrderVO.dimUnitYnExpress)}">
												<div class="row hr-8">
													<c:if test="${!empty expressOrderVO.userHeightYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.userHeightYn}"> orderNm </c:if>">Height</div>
														<div class="col-xs-2 center">
															<input class="col-xs-12 volumeWeight <c:if test="${!empty optionOrderVO.userHeightYn}"> orderVal </c:if>" readonly floatOnly type="text" name="userHeight" id="userHeight" value="${userOrder.userHeight}" />
														</div>
													</c:if>
													<c:if test="${!empty expressOrderVO.userLengthYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.userLengthYn}"> orderNm </c:if>">Length</div>
														<div class="col-xs-2 center">
															<input class="col-xs-12 volumeWeight <c:if test="${!empty optionOrderVO.userLengthYn}"> orderVal </c:if>" readonly floatOnly type="text" name="userLength" id="userLength" value="${userOrder.userLength}" />
														</div>
													</c:if>
													<c:if test="${!empty expressOrderVO.userWidthYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.userWidthYn}"> orderNm </c:if>">Width</div>
														<div class="col-xs-2 center">
															<input class="col-xs-12 volumeWeight <c:if test="${!empty optionOrderVO.userWidthYn}"> orderVal </c:if>" readonly floatOnly type="text" name="userWidth" id="userWidth" value="${userOrder.userWidth}" />
														</div>
													</c:if>
													<c:if test="${!empty expressOrderVO.dimUnitYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.dimUnitYn}"> orderNm </c:if>">길이 단위</div>
														<div class="col-xs-2 center">
														<input type="text" class="col-xs-12 volumeWeight <c:if test="${!empty optionOrderVO.dimUnitYn}"> orderVal </c:if>" readonly id="dimUnit" name="dimUnit" value="${userOrder.dimUnit}">
														</div>
													</c:if>
												</div>
											</c:if>
											...
											<c:if test="${(!empty expressOrderVO.userWtaYnExpress) or (!empty expressOrderVO.userWtcYnExpress) or (!empty expressOrderVO.boxCntYnExpress) or (!empty expressOrderVO.wtUnitYnExpress)}">
												<div class="row hr-8">
													<c:if test="${!empty expressOrderVO.userWtaYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.userWtaYn}"> orderNm </c:if>">실무게</div>
														<div class="col-xs-2 center">
															<input class="col-xs-12 <c:if test="${!empty optionOrderVO.userWtaYn}"> orderVal </c:if>" floatOnly readonly type="text" name="userWta" id="userWta" value="${userOrder.userWta }" />
														</div>
													</c:if>
													<c:if test="${!empty expressOrderVO.userWtcYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.userWtcYn}"> orderNm </c:if>">부피 무게</div>
														<div class="col-xs-2 center">
															<input class="col-xs-12 <c:if test="${!empty optionOrderVO.userWtcYn}"> orderVal </c:if>" floatOnly readonly type="text" name="userWtc" id="userWtc" value="${userOrder.userWtc }" />
														</div>
													</c:if>
													<c:if test="${!empty expressOrderVO.boxCntYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.boxCntYn}"> orderNm </c:if>">박스 개수</div>
														<div class="col-xs-2 center">
															<input class="col-xs-12 <c:if test="${!empty optionOrderVO.boxCntYn}"> orderVal </c:if>" numberOnly readonly type="text" name="boxCnt" id="boxCnt" value="${userOrder.boxCnt }" />
														</div>
													</c:if>
													<c:if test="${!empty expressOrderVO.wtUnitYnExpress}">
														<div class="col-xs-1 center mp07 <c:if test="${!empty optionOrderVO.wtUnitYn}"> orderNm </c:if>">무게 단위</div>
														<div class="col-xs-2 center">
															<input class="col-xs-12 <c:if test="${!empty optionOrderVO.wtUnitYn}"> orderVal </c:if>" type="text" readonly id="wtUnit" name="wtUnit" value="${userOrder.wtUnit}">
														</div>
													</c:if>
												</div>
										...
										<div class="col-xs-12 col-lg-12 " style="font-size: 3;">
											...
											<div class="row hr-8">
												<div class="col-xs-1 center mp07 orderNm">수출신고</div>
												<div class="col-xs-2 center">
											...
											<div class="row hr-8 hide" id="expInputDiv" name="expInputDiv" style="font-size:12px !important;">
												<div class="col-xs-1 center mp07" id="expBusinessNameHead" name="expBusinessNameHead">수출화주사업자명</div>
												<div class="col-xs-3 center">
													<input class="col-xs-12" type="text" name="expBusinessName" id="expBusinessName" value="${userOrder.expBusinessName }" />
												</div>
												<div class="col-xs-1 center mp07" id="expBusinessNumHead" name="expBusinessNumHead">수출화주사업자번호</div>
												<div class="col-xs-3 center">
													<input class="col-xs-12" type="text" name="expBusinessNum" id="expBusinessNum" value="${userOrder.expBusinessNum }" />
												</div>
												<div class="col-xs-1 center mp07" id="expShipperCodeHead" name="expShipperCodeHead">수출화주통관부호</div>
												<div class="col-xs-3 center">
													<input class="col-xs-12" type="text" name="expShipperCode" id="expShipperCode" value="${userOrder.expShipperCode }" />
												</div>
												<div class="space-20"></div>
												<div class="col-xs-1 center mp07" id="expNoHead" name="expNoHead">수출면장번호</div>
												<div class="col-xs-3 center">
													<input class="col-xs-12" type="text" name="expNo" id="expNo" value="${userOrder.expNo }" placeholder="수출면장번호가 있는 경우만 입력" />
												</div>
												
												<div class="col-xs-1 center mp07" id="agencyBusinessNameHead" name="agencyBusinessNameHead">수출대행사업자명</div>
												<div class="col-xs-3 center">
													<input class="col-xs-12" type="text" name="agencyBusinessName" id="agencyBusinessName" value="${userOrder.agencyBusinessName}"/>
												</div>
											</div>
											<div class="hr dotted"></div>
										</div>
								...
								<div class="col-xs-12 col-lg-12">
									<div class="col-xs-12 col-lg-3 form-group" style="font-size: 5;">
										...
										<c:if test="${!empty expressOrderVO.foodYnExpress}">
											<div class="col-xs-12 col-lg-4 center mp07 <c:if test="${!empty optionOrderVO.foodYn}"> orderNm </c:if>">음식 포함 여부</div>
									...
									<div class="col-xs-12 col-lg-12" style="border: 1px solid #dee2e6 !important; padding: 3rem !important">
										<br/><input type="hidden" id="itemInfoCnt" name="itemInfoCnt" value="${fn:length(userOrderItem)}">
													...
													<div class="panel-heading">
														<h4 class="panel-title">
															<span class="accordion-toggle">
																<span data-toggle="collapse" href="#collapse${status.count}"> &nbsp;Item #${status.count}
																	...
																	<c:if test="${!empty expressItemVO.trkComYnExpress}">
																		<div class="col-md-6 col-xs-12">
																			...
																			<div class="col-md-9 col-xs-12">
																				<input class="width-100 checkItem <c:if test="${!empty optionItemVO.trkComYn}"> itemVal </c:if>" type="text" name="trkCom" id="trkCom${status.count}" value="${orderItem.trkCom}" /> <input class="width-100" type="hidden" name="subNo" id="subNo${status.count}" value="${orderItem.subNo}" />
																			</div>
																		</div>
																	</c:if>
																	<c:if test="${!empty expressItemVO.trkDateYnExpress}">
																		<div class="col-md-6 col-xs-12">
																			...
																			<div class="col-md-9 col-xs-12">
																				<div class="input-group input-group-sm">
																					<span class="input-group-addon"> <i class="ace-icon fa fa-calendar"></i>
																					</span> <input type="text" id="trkDate${status.count}" name="trkDate" class="width-100 checkItem <c:if test="${!empty optionItemVO.trkDateYn}"> itemVal </c:if>" onclick="javascript:test(this);" value="${orderItem.trkDate}" />
																				</div>
																			</div>
																		</div>
																	</c:if>
