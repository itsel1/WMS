...
<html lang="en">
	...
	<body class="no-skin">
											...
											<div class="widget-body">
												...
												<div class="row">
													<div class="col-xs-offset-6 col-xs-6">
														<div class="col-xs-6">
															<label class="bolder bigger-150 verticalM">반품 검수 추가 비용</label>
														</div>
														<div class="col-xs-6">
															<input id="depositAddPrice" name="depositAddPrice" class="depositAddPrice width-100" floatOnly size="5" type="text" tabindex="1" />
														</div>
													</div>
												</div>
											</div>
		...
		$("#resetBtn").on('click',function(){
			location.href = "/mngr/aplctList/return/inspListOut/"+$("#orderReference").val();
		})
		...
		function showDetail(targetStockNo){
			...
			$.ajax({
				...
				data : list,
				url : "/mngr/aplctList/return/inspListOut/StockOutDetail",
				error : function(){
					alert("subpage ajax Error");
				},
				success : function(rtnVal2){
