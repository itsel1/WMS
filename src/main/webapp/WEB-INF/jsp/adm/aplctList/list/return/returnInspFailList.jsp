...
<html>
	...
	<body class="no-skin">
							                    	 				...
							                    	 				<tr>
																		...
																		<c:if test="${itemStatus.first}">
																			<td rowspan="${fn:length(inspList.orderItemList)}" style="vertical-align: middle; border:none;">
																				<input class="btn btn-sm btn-danger btn-white" id="btnReturnDel" name="btnReturnDel" onclick="inspDel('${inspList.ORDER_REFERENCE}')" type="button" value="폐기"/>
																				
																				<input class="btn btn-sm btn-success btn-white" id="btnReturnOut" name="btnReturnOut" onclick="inspOut('${inspList.ORDER_REFERENCE}')" type="button" value="강제출고"/>
      ...
      <!-- excel upload 추가 -->
         ...
         function inspDel(orderReference){
        	 window.open("/mngr/aplctList/return/inspDel/"+orderReference, "PopupWin", "width=1000,height=800");
         }
