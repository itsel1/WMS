												...
												<tr>
					                    	 	...
					                    	 	<tr>
					                    	 		<td colspan="8" style="vertical-align: middle;">
					                    	 			<div class="row">
					                    	 				<div class="col-xs-12">
					                    	 					총 주문금액 : ${inspList.TOTAL_VALUE} ${inspList.orderItemList[0].UNIT_CURRENCY}
					                    	 				</div>
					                    	 				<div class="col-xs-12">
							                    	 				...
							                    	 				<c:forEach items="${inspList.orderItemList}" var="inspItemList" varStatus="itemStatus">
								                    	 				<tr>
								                    	 					...
								                    	 					<td style="text-align: center;">
								                    	 						...
								                    	 						<img src="${inspItemList.ITEM_IMG_URL }" width="100px" height="100px" onerror="this.style.display='none';">
								                    	 					</td>
								                    	 					<td  style="vertical-align: middle;">
								                    	 						<div class="row">
								                    	 							<div class="col-xs-2">
																			...
																			<c:if test="${itemStatus.first}">
																				<td rowspan="${fn:length(inspList.orderItemList)}" style="vertical-align: middle; border:none;">
																					<input class="btn btn-sm btn-success btn-white" id="btnReturnInsp" name="btnReturnInsp" onclick="inspStart('${inspList.ORDER_REFERENCE}')" type="button" value="검수하기"/>
																				</td>
																			</c:if>
																		</tr>
																	</c:forEach>
