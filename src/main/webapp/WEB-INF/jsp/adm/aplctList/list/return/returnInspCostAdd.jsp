			                    	 			...
			                    	 			<div class="row">
			                    	 				<div class="col-xs-12">
					                    	 			<table class="table table-bordered table-hover containerTable">
															...
															<tr>
																<th class="center">추가비용</th>
																<td style="text-align: left;padding:0px;">
																	<div class="row">
																		<div class="col-xs-2">
																			<select id="costType" name="costType">
																				<option value="B002">검수 추가비용</option>
																				<option value="B004">합포장</option>
																				<option value="B005">사진추가</option>
																				<option value="B006">부자재</option>
																				<option value="B007">기타</option>
																			</select>
																		</div>
																		<div class="col-xs-10 text-left hide" id="detailDiv" name="detailDiv">
																			기타 상세:<input type="text" style="width:85%" id="etcDetail" name="etcDetail" value=""/>
																		</div>
																	</div>
																	<input type="number" id="chgAmt" name="chgAmt" value="" style="width:100%">
																</td>
															</tr>
														</table>
													</div>
      ...
      <!-- script addon start -->
		<script type="text/javascript">
			...
			$("#saveBtn").on("click",function(e){
				...
				$.ajax({
					url: "/mngr/aplctList/return/add/"+$("#orderReference").val(),
					type: 'POST',
					data: formData,
