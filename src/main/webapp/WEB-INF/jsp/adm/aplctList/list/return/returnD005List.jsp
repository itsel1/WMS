	...
	<body class="no-skin">
							                    	 				...
							                    	 				<tr>
																		...
																		<c:if test="${itemStatus.first}">
																			<td rowspan="${fn:length(inspList.orderItemList)}" style="vertical-align: middle; border:none;">
																				<input class="btn btn-sm btn-danger btn-white" id="readBtn" name="readBtn" onclick="fnRead('${inspList.ORDER_REFERENCE}')" type="button" value="상세보기"/>
																			</td>
																		</c:if>
																	</tr>
																</c:forEach>
      ...
      <!-- excel upload 추가 -->
         ...
         function fnRead(orderReference){
        	 location.href="/mngr/aplctList/return/D005/"+orderReference;
         }
