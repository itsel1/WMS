	...
	<body class="no-skin">
													...
													<div class="col-xs-12 col-lg-12" style="border: 1px solid #dee2e6!important; padding: 3rem!important">
														...
														<div class="col-xs-12 col-lg-12" style="font-size: 3;">
															...
															<div class="row hr-8">
																...
																<div class="col-xs-3 center">
																	<input class="col-xs-12" type="text" placeholder="숫자만 입력 가능합니다." numberOnly name="shipperHp" id="shipperHp" value="${userOrder.shipperHp}" />
																</div>
															</div>
																	...
																	<div class="panel-body">
																		<div class="row  hr-8">
																			...
																			<div class="col-md-6 col-xs-12">
																				...
																				<div class="col-md-9 col-xs-12">
																					<input class="width-100 itemVal trkInfo" type="text" name="trkCom" id="trkCom${status.count}" value="${orderItem.trkCom}" />
																			...
																			<div class="col-md-6 col-xs-12">
																				...
																				<div class="col-md-9 col-xs-12">
																					<div class="input-group input-group-sm">
																						...
																						<input type="text" id="trkDate${status.count}" name="trkDate" class="form-control trkDate" value="${orderItem.trkDate}"/>
																					</div>
																				</div>
																			</div>
																		</div>
																		<div class="row  hr-8">
																			<div class="col-md-6 col-xs-12">
																				...
																				<div class="col-md-9 col-xs-12">
																					<input class="width-100 itemVal trkInfo" type="text" name="trkNo" id="trkNo${status.count}" value="${orderItem.trkNo}" />
																				</div>
																			</div>
																			<div class="col-md-6 col-xs-12">
		...
		<script type="text/javascript">
			...
			$('#rgstrInfo').on('click',function(e){
				var formData = $("#registForm").serialize();
				$.ajax({
					url:'/mngr/aplctList/updateTrkNos',
					type: 'POST',
					beforeSend : function(xhr)
					{   /*데이터를 전송하기 전에 헤더에 csrf값을 설정한다*/
					    xhr.setRequestHeader("${_csrf.headerName}", "${_csrf.token}");
