	...
	<div class="panel panel-default panels${cnt}">
		...
		<div class="panel-collapse collapse multi-collapse in" id="collapse${cnt}">
			<div class="panel-body">
				...
				<div class="col-md-6 col-xs-12 hr-8">
					<div class="col-md-3 col-xs-12 pd-1rem center mp07 <c:if test="${!empty optionItemVO.itemWtUnitYn}"> itemNm </c:if>"  >상품 무게</div>
					<div class="col-md-9 col-xs-12">
						<input class="width-100 checkItem <c:if test="${!empty optionItemVO.itemWtUnitYn}"> itemVal </c:if>" " type="text" name="userItemWta" id="userItemWta${cnt}" value="" />
					</div>
				</div>
				<%-- <c:if test="${!empty expressItemVO.hsCodeYnExpress}">	
					<div class="col-md-6 col-xs-12 hr-8">
