				...
				<div class="page-content">
					...
					<div id="inner-content-side">
						<form name="whoutForm" id="whoutForm" enctype="multipart/form-data">
							<input type="hidden" id="idx" name="idx" value="${noticeInfo.idx}">
							<input type="hidden" id="groupIdx" name="groupIdx" value="${noticeInfo.groupIdx}">
							<input type="hidden" id="step" name="step" value="${noticeInfo.step}">
							<input type="hidden" id="indent" name="indent" value="${noticeInfo.indent}">
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			$(document).ready(function() {
				...
				///$("#summernote").val("${fn:replace(cNoticeInfo.content,'\"','\\"')}");
        ...
        $("#regist-btn").on('click', function() {
            $("#whoutForm").attr("action", "/mngr/board/noticeReplyIn");
