				...
				<div class="page-content">
					...
					<div id="inner-content-side">
						<form name="whoutForm" id="whoutForm" enctype="multipart/form-data">
							...
							<input type="hidden" name="cIdx" value="${cNoticeInfo.cIdx}">
							<input type="hidden" name="depth" value="${cNoticeInfo.depth}">
							<input type="hidden" name="indent" value="${cNoticeInfo.indent}">
		...
		$("#regist-btn").on('click', function() {
			$.ajax({
				...
				success : function(result) {
					location.href = "/mngr/board/whoutOrder";
				},
