	...
	<body class="no-skin">
							...
							<div id="search-div">
										...
										<form class="hidden-xs hidden-sm" name="searchForm" id="searchForm">
											<div class="input-group">
												...
												<div class="input-group input-daterange">
													<input type="text" class="dateClass form-control" name="startDate" value="${startDate}"/>
														<span class="input-group-addon">
															to
														</span>
													<input type="text" class="dateClass form-control" name="endDate" value="${endDate}"/>
								...
								<br>
									...
									<div id="rgstr-user" style="text-align: right">
										<input type="button" class="btn btn-sm btn-primary" name="rgstBtn" id="rgstBtn" value="등록하기">
									 	<div class="hidden">
								...
								<table id="dynamic-table" class="table table-bordered table-hover" style="width:100%;">
									<thead>
										<tr>
											...
											<th class="center colorBlack" >등록 배송 수</th>
											<th class="center colorBlack" >기타</th>
										</tr>
									</thead>
									<tbody>
									<c:forEach items = "${clearanceListCnt}" var="clearance" varStatus="status">
										<tr>
											...
											<td class="center" style="word-break:break-all; width:25%; vertical-align: middle;">
												${clearance.clearanceCnt}
											</td>
											<td class="center" style="word-break:break-all;">
												<input type="button" class="btn btn-white btn-inverse btn-sm" onclick="fn_detail('${clearance.wDate}')" value="상세보기"/>
												<input type="button" class="btn btn-white btn-sm btn-success " onclick="fn_excelDown('${clearance.wDate}')" value="excel 다운로드"/>
											</td>
										</tr>
									</c:forEach>
									</tbody>
		...
		<script type="text/javascript">
			...
			function fn_excelDown(wDate) {
				window.open("/mngr/invoice/clearanceOneExcelDown?wDate="+wDate, '_blank');
			}
		</script>
		<!-- script addon end -->
	</body>
