		...
		<script type="text/javascript">
			...
			$("#scrhBtn").on('click ', function(){
			    ...
			    $(grid_selector).setGridParam({
			        url:'/mngr/rls/mawbSearch',    //*.json 으로 controller 호출
			        datatype: 'json',
			        mtype : 'get',
			        postData: {
			...
			function mawbShow(mawbNo){
				/* $('.ui-jqgrid-titlebar-close').trigger("click"); */
				window.open("/mngr/rls/mawbDetail?target="+mawbNo,"_blank","toolbar=no","resizable=yes","directories=no","width=1000, height=960");
