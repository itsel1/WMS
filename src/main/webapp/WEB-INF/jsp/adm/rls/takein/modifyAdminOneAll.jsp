	...
	<body class="no-skin">
												...
												<div class="col-xs-12 col-lg-12" >
													...
													<div class="row hr-8">
														...
														<div class="col-xs-2 center">
															...
															<select class="form-control" id="transCode" name="transCode" disabled>
																<option value="${userOrder.transCode}">${userOrder.transCode}</option>
															</select>
														</div>
														<div class="col-xs-1 center mp07">
															관세 지급 방식
																		...
																		<div class="panel-body">
																			<div class="row hr-8">
																				<div class="col-md-6 col-xs-12 hr-8">
																					...
																					<div class="col-md-9 col-xs-12">
																						<input class="width-100 checkItem <c:if test="${!empty optionItemVO.cusItemCodeYn}"> itemVal </c:if>" readonly type="text" name="cusItemCode" id="cusItemCode${status.count}" value="${orderItem.cusItemCode}" />
																					</div>
																				</div>
																				<div class="col-md-6 col-xs-12 hr-8">
																					<div class="col-md-3 col-xs-12 pd-1rem center mp07">사입 코드</div>
																					<div class="col-md-9 col-xs-12">
																						<input class="width-100 checkItem" type="text" name="takeInCode" id="takeInCode${status.count}" readonly value="${orderItem.takeInCode}" />
																					</div>
																				</div>
																			</div>
																			...
																			<c:if test="${!empty expressItemVO.chgCurrencyYnExpress}">
																				<div class="col-md-6 col-xs-12 hr-8">
																					...
																					<div class="col-md-9 col-xs-12">
																						<input class="width-100 checkItem" type="hidden" name="unitCurrency" id="unitCurrency${status.count}" value="${orderItem.unitCurrency}" />
		...
		var cnt = $("#itemInfoCnt").val();
			...
			$('#rgstrInfo').on('click',function(e){
				...
				var formData = $("#registForm").serialize();
				$.ajax({
					url:'/mngr/takein/modifyAdminOne',
					type: 'POST',
					beforeSend : function(xhr)
					{   /*데이터를 전송하기 전에 헤더에 csrf값을 설정한다*/
					    xhr.setRequestHeader("${_csrf.headerName}", "${_csrf.token}");
