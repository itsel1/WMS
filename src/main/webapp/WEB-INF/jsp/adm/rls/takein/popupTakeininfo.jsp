					...
					<div class="page-content">
						<div class="col-xs-12 col-sm-12" id="inner-content-side">
						 <form id="mgrForm" action="" method="get">
						 		...
						 		<input type="hidden" name="orgStation" value="${takeInInfo.orgStation}">
								  ...
								  <thead>
									<tr>
										...
										<td style="padding:0px;">
											<input name="userId" id="userId" style="width:100%" type="text" required value="${takeInInfo.userId}">
										</td>
										...
										<select name="useYn" style="width:100%">
												<option value="N" <c:if test="${takeInInfo.useYn =='N' }">selected</c:if>>미사용</option>
												<option value="Y" <c:if test="${takeInInfo.useYn =='Y' }">selected</c:if> >사용</option>
											</select>
										</td>
									</tr>
									<tr>
										...
										<td style="padding:0px;">
											<input name="cusItemCode" id="cusItemCode" style="width:100%" type="text" required value="${takeInInfo.cusItemCode}">
										</td>
										<td style="padding:0px;">
										     <select name="appvYn" style="width:100%">
										        <option value="N" <c:if test="${takeInInfo.appvYn =='N' }">selected</c:if>>미승인</option>
												<option value="Y" <c:if test="${takeInInfo.appvYn =='Y' }">selected</c:if>>승인</option>
											</select>
										</td>
									</tr>
									<tr>
									...
									<tr>
										<th class="center colorBlack">상품 바코드</th>
										<td style="padding:0px;" colspan=3>
											<input id="itemBarcode" name="itemBarcode" style="width:100%" type="text" value="${takeInInfo.itemBarcode}">
										</td>
									</tr>
									<tr>
										<th class="center colorBlack"><span style="padding:0;color:red">*</span>  상품명(영문)</th>
										<td style="padding:0px;" colspan=3>
											<input id="itemDetail" name="itemDetail" style="width:100%" type="text" required value="${takeInInfo.itemDetail}">
										</td>
									</tr>
									<tr>
										...
										<td style="padding:0px;">
											<select style="width:100%" name="unitCurrency">
												<c:forEach items="${currList}" var="list">
													<option value="${list.currency}" <c:if test="${list.currency eq takeInInfo.unitCurrency}">selected</c:if>>${list.currency} (${list.nationName})</option>
												</c:forEach>
											</select>
										</td>
									</tr>
									...
									<tr>
										...
										<td style="padding:0px;">
											<input name="wtc" style="width:100%" type="number" value="${takeInInfo.wtc }">
										</td>
									</tr>
										<tr>
										...
										<tr>
											...
											<td style="padding:0px" colspan=3>
												<input type="text" name="itemUrl" style="width:100%;" value="${takeInInfo.itemUrl}">
											</td>
										</tr>
										<tr>
		...
		<!-- script addon start -->
			...
			jQuery(function($) {
				...
				$("#itemBarcode").focus();
		     	...
		     	$("#itemBarcode").keydown(function(key) {
		     		if (key.keyCode == 13) {
		     			if( $("#userId").val() == ""){
