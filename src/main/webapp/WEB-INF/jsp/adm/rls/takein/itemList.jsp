		...
		<div class="panel-collapse collapse multi-collapse in" id="collapse${cnt}">
			<div class="panel-body">
				<div class="row hr-8">
					...
					<div class="col-md-6 col-xs-12 hr-8">
						<div class="col-md-3 col-xs-12 pd-1rem center mp07">사입 코드</div>
						<div class="col-md-9 col-xs-12">
							<input class="width-100 checkItem" type="text" name="takeInCode" id="takeInCode${cnt}" value="${orderItem.takeInCode}" />
						</div>
					</div>
				</div>
				...
				<c:if test="${!empty expressItemVO.trkComYnExpress}">
					<div class="col-md-6 col-xs-12">
						...
						<div class="col-md-9 col-xs-12">
							<input class="width-100 trkInfo checkItem <c:if test="${!empty optionItemVO.trkComYn}"> itemVal </c:if>" type="text" name="trkCom" id="trkCom${cnt}" value="${orderItem.trkCom}" />
					...
					<div class="col-md-6 col-xs-12">
						...
						<div class="col-md-9 col-xs-12">
							<div class="input-group input-group-sm">
								...
								<input type="text" id="trkDate${cnt}" name="trkDate" class="width-100 trkInfo checkItem <c:if test="${!empty optionItemVO.trkDateYn}"> itemVal </c:if>" onclick="javascript:test(this);" value="${orderItem.trkDate}"/>
							</div>
						</div>
					</div>
				</c:if>
				...
				<c:if test="${!empty expressItemVO.trkNoYnExpress}">
					<div class="col-md-6 col-xs-12">
						...
						<div class="col-md-9 col-xs-12">
							<input class="width-100 trkInfo checkItem <c:if test="${!empty optionItemVO.trkNoYn}"> itemVal </c:if>" type="text" name="trkNo" id="trkNo${cnt}" value="${orderItem.trkNo}" />
							<%-- <div class="input-group input-group-sm">
					...
					<div class="col-md-6 col-xs-12">
						...
						<div class="col-md-9 col-xs-12">
							<input class="width-100 checkItem <c:if test="${!empty optionItemVO.hsCodeYn}"> itemVal </c:if>" type="text" name="hsCode" id="hsCode${cnt}" value="${orderItem.hsCode}" />
						</div>
					</div>
					</c:if>
				</div>
				...
				<c:if test="${!empty expressItemVO.itemExplanYnExpress}">
					...
					<div class="col-md-6 col-xs-12 hr-8">
						...
						<div class="col-md-9 col-xs-12">
							<input class="width-100 checkItem itemVal" type="text" name="inBoxNum" id="inBoxNum${cnt}" value="${orderItem.inBoxNum}" />
						</div>
					</div>
				...
				<c:if test="${!empty expressItemVO.itemUserWtaYnExpress}">	
					<div class="col-md-6 col-xs-12 hr-8">
						...
						<div class="col-md-9 col-xs-12">
							<input class="width-100 checkItem <c:if test="${!empty optionItemVO.itemUserWtaYn}"> itemVal </c:if>" type="text" name="userWtaItem" id="userWta${cnt}" value="${orderItem.userWta}" />
						</div>
					</div>
				</c:if>
				...
				<c:if test="${!empty expressItemVO.chgCurrencyYnExpress}">
					<div class="col-md-6 col-xs-12 hr-8">
						...
						<div class="col-md-9 col-xs-12">
							...
							<c:if test="${empty orderItem.chgCurrency}">
								<input class="width-100 checkItem <c:if test="${!empty optionItemVO.chgCurrencyYn}"> itemVal </c:if>" type="text" name="chgCurrency" id="chgCurrency${cnt}" value="${orderItem.unitCurrency}" />
							</c:if>
						</div>
					</div>
				</c:if>
