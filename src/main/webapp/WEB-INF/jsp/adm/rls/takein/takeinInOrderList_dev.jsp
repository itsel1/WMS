								...
								<div class="display" >
									<table id="dynamic-table " class="table table-bordered ">
										...
										<tbody style="background-color:#fff;">
											...
											<c:set var="itemSize" value="${fn:length(list.takeinOrderItem)}"/>
											<c:forEach items="${list.takeinOrderItem}" var="itemList" varStatus="subStatus">
											<tr>
											<c:if test="${subStatus.index == 0}">
												<td style="text-align: center" rowspan="${itemSize}">
													<input type="checkbox" name="nno[]" value="${list.nno}">
												</td>
												<td class="center colorBlack" rowspan="${itemSize}">											
													${list.rownum}
												</td> 
												<td class="center colorBlack" rowspan="${itemSize}">
													${list.orderDate}
												...
												<td style="text-align:left;width:200px;" rowspan="${itemSize}">
													${list.cneeZip} ${list.cneeAddr} ${list.cneeAddrDetail}
												</td>
												<td class="center colorBlack" rowspan="${itemSize}">
													${list.cneeTel}
												</td>
												<td style="text-align:right;" rowspan="${itemSize}">
													${list.totalItemCnt}
												</td>
												<td style="text-align:right;" rowspan="${itemSize}">
													${list.totalWta}
												...
												<td class="center colorBlack">${itemList.rackCode}</td>
												<td class="center colorBlack">${itemList.cusItemCode}</td>
												<td style="text-align:right;">${itemList.itemCnt}</td>
											</tr>
											</c:forEach>
										</tbody>
									</table>
