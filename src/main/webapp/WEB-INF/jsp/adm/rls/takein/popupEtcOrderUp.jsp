				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="col-xs-12 col-sm-12" id="inner-content-side">
						 <form id="mgrForm">
						 		<input type="hidden" name="nno" id="nno" value="${takeinInfo.nno}"/>
						 		<input type="hidden" name="etcIdx" id="etcIdx" value="${takeinInfo.etcIdx}"/>
								  ...
								  <thead>
									...
									<tr>
										...
										<td style="padding:0px;width:200px;" colspan=1>
											<input type="text" id="orderDate" name="orderDate" style="width:100%" value="${takeinInfo.orderDate}" readonly="readonly"/>
										</td>
									...
									<th class="center colorBlack" style="width:100px;">Remark</th>
										<td style="padding:0px;width:200px;" colspan=3>
											<input type="text" style="width:100%" name="remark" value="${takeinInfo.remark}">
										</td>
									</tr>
									</thead>
								</table>
								...
								<table id="itemInfo" class="table table-bordered" style="width:100%;">
									<thead>
										<tr>
											<th class="center colorBlack" style="width:20%;">TakeInCode</th>
											<th class="center colorBlack" style="width:20%;">CusItemCode</th>
											<th class="center colorBlack">ItemDetail</th>
											<th class="center colorBlack" style="width:10%;">itemCnt</th>
											<th class="center colorBlack" style="width:5%;"></th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${takeinItem}" var="itemList">
											<tr>
												<th class="center colorBlack" style="padding:0px;">
													<input type="text" class="takeInCode" readonly name="takeInCode[]" value="${itemList.takeInCode}"/>
 												</th>
 												<th class="center colorBlack" style="padding:0px;">
													<input type="text" class="cusItemCode" readonly name="cusItemCode[]" value="${itemList.cusItemCode}"/>
 												</th>
 												<th class="center colorBlack" style="padding:0px;">
													<input type="text" class="itemDetail" readonly name="itemDetail[]" value="${itemList.itemDetail}"/>
 												</th>
 												<th class="right colorBlack" style="padding:0px;">
													<input type="number" style="text-align:right" class="itemCnt" name="itemCnt[]" value="${itemList.itemCnt}"/>
 												</th>
 												<td style="text-align:center"><input type="button" class="btnTrDel" value="삭제"/></td>
											</tr>
										</c:forEach>
									</tbody>
										<tfoot>
