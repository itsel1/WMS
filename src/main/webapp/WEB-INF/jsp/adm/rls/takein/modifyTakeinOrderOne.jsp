												...
												<div class="col-xs-12 col-lg-12" >
													...
													<div class="row hr-8">
														...
														<div class="col-xs-2 center">
															<select class="form-control" id="payment" disabled name="payment">
																<option <c:if test="${userOrder.payment eq 'DDU' }"> selected </c:if>value="DDU">DDU</option>
																<option <c:if test="${userOrder.payment eq 'DDP' }"> selected </c:if>value="DDP">DDP</option>
															</select>
														</div> 
													</div>
													<br/>
													...
													<div class="col-xs-12 col-lg-12" style="border: 1px solid #dee2e6!important; padding: 3rem!important">
														...
														<div class="col-xs-12 col-lg-12 " style="font-size: 3;">
															...
															<div class="row hr-8 disable" id="expInputDiv" name="expInputDiv">
																		...
																		<div class="panel-body">
																			...
																			<c:if test="${!empty expressItemVO.itemUserWtaYnExpress}">	
																				<div class="col-md-6 col-xs-12 hr-8">
																					...
																					<div class="col-md-9 col-xs-12">
																						<input class="width-100 checkItem <c:if test="${!empty optionItemVO.itemUserWtaYn}"> itemVal </c:if>" type="text" name="userWtaItem" id="userWta${status.count}" value="${orderItem.userWta}" />
																					</div>
																				</div>
																			</c:if>
																			<%-- <c:if test="${!empty expressItemVO.hsCodeYnExpress}">	
