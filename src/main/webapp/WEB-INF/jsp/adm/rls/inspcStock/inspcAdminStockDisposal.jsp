				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="col-xs-12 col-sm-12" id="inner-content-side">
							...
							<div id="table-contents" class="table-contents" style="width:100%; overflow: auto; height:580px;">
										...
										<tbody>
											<c:forEach items="${inspStockList}" var="inspStockInfo" varStatus="status">
													<tr>
														...
														<td style="all:none;padding:0px;vertical-align:top;">
