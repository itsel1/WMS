				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="col-xs-12 col-sm-12" id="inner-content-side">
							...
							<input type=hidden id="orgStation" name="orgStation" value="${parameters.orgStation}">
							<input type="hidden" id="userId" name="userId" value="${parameters.userId}">
