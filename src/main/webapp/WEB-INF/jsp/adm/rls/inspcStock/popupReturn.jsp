					...
					<div class="page-content">
						<div class="col-xs-12 col-sm-12" id="inner-content-side">
							...
							<form id="mgrForm" action="" method="post">
								...
								<input type="hidden" name="disposalType" value="RT">
								<table class="table table-bordered" style="width:330px;">
									<thead>
										<tr>
											<th class="center" style="width:100px;">TrackCom</th>
											<td style="text-align: left;padding:0px;width:200px;"><input type="text" id="trkCom" name="trkCom" value="" style="width:100%"></td>
										</tr>
										<tr>
											<th class="center">TrkNo</th>
											<td style="text-align: left;padding:0px;"><input type="text" id="trkNo" name="trkNo" value="" style="width:100%"></td>
										</tr>
										<tr>
