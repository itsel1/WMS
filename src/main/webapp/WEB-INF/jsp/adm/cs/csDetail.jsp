	...
	<body class="no-skin">
					...
					<div class="page-content">
						...
						<div id="inner-content-side">
							<div class="page-header" style="border-bottom: 1px solid black;">
								<h2> 
									제목  <input type = "text" name = "title" value ="${csInfo.title}" readonly>
								</h2>
								
								<h2>
									작성자 <input type = "text" name = "writer" value = "${csInfo.userId }" readonly>
								</h2>
								<h2>
									작성일 <input type = "text" name ="date" value = "${csInfo.regDate }" readonly>
								</h2>
							</div>
							...
							<div id="inner-content-side" >
								<div id="table-contents" class="table-contents" style="width:100%; overflow: auto; font-size:medium;">
									<div id="viewer"></div>
									내용
									<input type="text" id="viewContents" value='${csInfo.contents }'/>
								</div>
							</div>
							...
							<c:if test="${noticeDetail.prevYn  > 0 }">
								...
								<button class="btn byn-white btn-md btn-info" id="edit">수정</button>
							</div>
						</div>
					</div>
				</div>
		...
		<script type="text/javascript">
			function fnTrClick(idx){
				location.href="/mngr/cs/csDetail?nno="+nno;
			}
			$('#backList').on('click',function(e){
				location.href="/mngr/cs/csBoard";
			})
			$('#edit').on('click', function(e){
				location.href="/mngr/cs/csUpdate";
				})
			/* 
