				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div id="inner-content-side" >
							...
							<div id="search-div">
								<br>
								<form name="search-button" id="search-botton" method="get" action="/mngr/acnt/indvdList">
								...
								<table id="dynamic-table" class="table table-bordered table-hover" style="width:100%;">
									<thead>
										<tr>
											...
											<th class="center colorBlack" >사용자 등급</th>
									...
									<tbody>
										<c:forEach items="${userInfo}" var="test">
											<tr>
												...
												<td class="center" style="word-break:break-all;">
													<a href="/mngr/acnt/zone/${test.userId}">설정하기</a>
												</td>
												<td class="center" style="word-break:break-all;">
													${test.aprvYn}
												</td>
