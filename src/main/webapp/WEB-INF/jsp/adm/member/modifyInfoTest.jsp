										...
										<div class="tab-content">
											...
											<div id="tab3" class="tab-pane fade">
												...
												<div class="row form-group hr-8">
													...
													<div class="col-lg-1 col-xs-12" style="margin-top:4px;">
														<c:if test="${!empty userInfo.apiKey}">
												...
												<div class="row form-group hr-8">
													...
													<div class="col-lg-12 col-xs-12" name="ipList" id="ipList">
														<c:forEach items="${allowIpList }" var="allowIp" varStatus="status">
															<div class="col-lg-4 col-xs-12" id="allowIp${status.count}" name="allowIp">
												...
												<div class="row form-group hr-8">
													...
													<div class="col-lg-12 col-xs-12" name="webHookList" id="webHookList">
														<c:forEach items="${webhookList}" var="webHook" varStatus="webHookStatus">
															<input type="text" style="border:none; border-bottom:1px solid gray; border-radius: 0rem !important; background-color: white !important;" readonly id="divKr${webHookStatus.count}" name="divKr" value="${webHook.divKr }">&nbsp;&nbsp;
															<input type="hidden" id="webHookDiv${webHookList.count}" name="webHookDiv" value="${webHook.divs}">
															<input type="text" style="border:none; border-bottom:1px solid gray; border-radius: 0rem !important; background-color: white !important;" id="webHookUrl${webHookStatus.count}" name="webHookUrl" value="${webHook.url }"><br/>
														</c:forEach>
													</div>
												</div> 
												<div class="space-20"></div>
												<div class="row form-group hr-8">
													<div class="col-lg-12 col-xs-12">
														<label>패스트박스 정보</label>
													</div>
													<div class="col-lg-12 col-xs-12">
														<div class="col-lg-3 col-xs-12 pd-1rem" >Mall ID</div>
														<div class="col-lg-6 col-xs-12">
															<input class="width-100" type="text" name="mallId" id="mallId" value="${fastboxInfo.mallId}" />
														</div>
													</div>
													<div class="col-lg-12 col-xs-12">
														<div class="col-lg-3 col-xs-12 pd-1rem" >판매사명</div>
														<div class="col-lg-6 col-xs-12">
															<input class="width-100" type="text" name="sellerName" id="sellerName" value="${fastboxInfo.sellerName}" />
														</div>
													</div>
													<div class="col-lg-12 col-xs-12">
														<div class="col-lg-3 col-xs-12 pd-1rem" >Consumer Key</div>
														<div class="col-lg-6 col-xs-12">
															<input class="width-100" type="text" name="consumerKey" id="consumerKey" value="${fastboxInfo.consumerKey}" />
														</div>
													</div>
													<div class="col-lg-12 col-xs-12">
														<div class="col-lg-3 col-xs-12 pd-1rem" >Token</div>
														<div class="col-lg-6 col-xs-12">
															<input class="width-100" type="text" name="token" id="token" value="${fastboxInfo.token}" />
														</div>
													</div>
													<div class="col-lg-12 col-xs-12">
														<div class="col-lg-3 col-xs-12 pd-1rem">사업자등록번호</div>
														<div class="col-lg-6 col-xs-12">
															<input class="width-100" type="text" name="comRegNo" id="comRegNo" value="${fastboxInfo.comRegNo}"/>
														</div>
													</div>
												</div>
											</div>
											...
											<div id="tab5" class="tab-pane fade">
												...
												<div class="row form-group hr-8">
													...
													<div class="col-lg-6 col-xs-12">
														...
														<div class="radio">
															<label>
																<input id="depositYn" name="depositYn" type="radio" class="ace" value="Y" <c:if test="${userInfo.depositYn eq 'Y'}"> checked</c:if>/>
																<span class="lbl"> 사용</span>
															</label>
															<label>
																<input id="depositYn" name="depositYn" type="radio" class="ace" value="N" <c:if test="${userInfo.depositYn eq 'N'}"> checked</c:if>/>
												...
												<div class="row form-group hr-8">
													...
													<div class="col-lg-6 col-xs-12">
														<label>반품메뉴 사용여부</label>
														<div class="radio">
															<label>
																<input name="returnYn" type="radio" class="ace" value="Y" <c:if test="${userInfo.returnYn eq 'Y'}"> checked</c:if>/>
																<span class="lbl"> 사용</span>
															</label>
															<label>
																<input name="returnYn" type="radio" class="ace" value="N" <c:if test="${userInfo.returnYn eq 'N'}"> checked</c:if>/>
																<span class="lbl"> 미사용</span>
															</label>
														</div>
													</div>
												...
												<%-- 
												<div id="depositDiv" name="depositDiv" class="row form-group hr-8 hide">
													<div class="col-lg-12 col-xs-12">
														<div class="col-lg-3 col-xs-12 pd-1rem" >예치금 입력</div>
														<div class="col-lg-6 col-xs-12">
															<input class="width-100" type="text" name="depositPrice" id="depositPrice" value="${userInfo.depositPrice}" />
														</div>
													</div>
												</div>
												<div class="row form-group hr-8">
												...
												<div class="row form-group hr-8">
													<div class="col-lg-12 col-xs-12">
														<div class="col-lg-3 col-xs-12 pd-1rem" >반송 기본비용</div>
														<div class="col-lg-6 col-xs-12">
											...
											<div id="tab6" class="tab-pane fade">
												...
												<div class="row form-group hr-8">
													<div class="col-xs-12 pd-1rem" >출발지</div>
													<div class="col-xs-12">
														<c:forEach items="${userOrgNation}" var="userOrgNation">
															<input type="hidden" id="userOrgNation" name="userOrgNation" value="${userOrgNation}">
														</c:forEach>
															
														<select class="chosen-select form-control tag-input-style pd-1rem" id="orgNation" name="orgNation" data-placeholder="국가를 선택해 주세요">
															<option value="">  </option>
												...
												<div class="row form-group hr-8">
													<div class="col-xs-12 pd-1rem" >도착지</div>
													<div class="col-xs-12">
												...
												<div class="row form-group hr-8">
													...
													<div class="col-lg-12 col-xs-12">
														<div class="col-lg-12 col-xs-12" name="trackComs" id="trackComs">
														</div>
													</div>
	...
	<script type="text/javascript">
		jQuery(function($) {
			...
			$('#myTab a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
				...
				if($(e.target).attr('href') == "#tab1") test(e);
				if($(e.target).attr('href') == "#tab2") test(e);
				if($(e.target).attr('href') == "#tab3") test(e);
				if($(e.target).attr('href') == "#tab4") test(e);
				if($(e.target).attr('href') == "#tab5") test(e);
				if($(e.target).attr('href') == "#tab6") test(e);
			})
			
			function test(e){
				currentTarget = $(e.target).attr('href');
			}
			...
			$("input[name=depositYn]").on('change',function(){
				if($(this).val() == "Y"){
					$("#depositDiv").removeClass("hide");
				}else{
					$("#depositDiv").addClass("hide");
				}
			});
			...
			$('#updateInfo').on('click', function(e) {
				...
				$(".targetCom:checked").each(function (index) {
					/* if ($(this).val() == 'KR_US_T86') {
						str += $(this).val() + ",KR_US_USP,KR_US_FED,KR_US_FEG,KR_US_FES,KR_US_DHL,";
					} else {
						str += $(this).val() + ",";	
					} */
					str += $(this).val() + ",";
			...
			$.ajax({
				...
				success : function(data) {
					if(data.result == "S"){
						...
						addHtml += "<div class='col-lg-4 col-xs-12' id='allowIp"+num+"' name='allowIp'>"
						addHtml += "<input type='text' style='width:130px;height:30px;background-color: white !important;' readonly value='"+data.allowIp+"'>";
						addHtml += '<i class="ace-icon fa fa-times" style="padding:6px; cursor: pointer;" onclick="javascript:fn_deleteIp(\'allowIp'+num+'\')"></i>'; 
						addHtml += "</div>";
