...
<div class="w3-content" style="max-width:1200px">
 ...
 <img class="mySlides" src="https://www.w3schools.com/w3css/img_mountains_wide.jpg" style="width:100%;display:none">
  ...
  <div class="w3-row-padding w3-section">
    ...
    <div class="w3-col s4">
      <img class="demo w3-opacity w3-hover-opacity-off" src="https://www.w3schools.com/w3css/img_snow_wide.jpg" style="width:100%;cursor:pointer" onclick="currentDiv(2)">
    </div>
    <div class="w3-col s4">
