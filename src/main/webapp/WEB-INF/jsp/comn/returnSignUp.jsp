...
<body>
	<div id="main-section">
		...
		<div class="main-title">
			...
			<div class="notice-text">
				...
				<spring:message code="signup.noticeText.part3.sub1" text="Should you have any questions or difficulties completing this application, please contact " /> 
				<a href="mailto:globalselling_admin@coupang.com">globalselling_admin@coupang.com</a> 
				<spring:message code="signup.noticeText.part3.sub2" text="for assistance." />
			</div>
		</div>
		<form id="registForm">
			...
			<fieldset>
				<%-- <h2 class="form-title center"><spring:message code="signup.progress1title" text="Enter Return Information"/></h2> --%>
	    		...
	    		<div class="fieldset-input-form">
		    		...
		    		<div class="line-item">
		    			<label for="dstnNation" class="input-label required-text"><spring:message code="signup.dstnNation" text="Return Destination Country"/></label>
			...
			<fieldset>
				...
				<div class="fieldset-input-form">
					...
					<%-- <div class="line-item">
						<label for="userCountry" class="input-label"><spring:message code="signup.userCountry" text="Country"/></label>
						<input type="text" id="userCountry" name="userCountry" autocomplete="off">
					</div> --%>
					<div class="line-item-row">
						<div class="line-item-column">
	...
	<script type="text/javascript">
		...
		$("#locale-lang").change(function(e) {
			...
			location.href = "/returnSignUp?lang="+value;
		});
