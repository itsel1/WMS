				...
				<div class="main-content-inner">
					<div class="page-content">
						<div class="col-xs-12 col-sm-12" id="inner-content-side">
									 ...
									 <thead>
										<tr>
											...
											<th class="left" style="background-color: white">
												...
												<c:if test="${!empty blinfo.trkNo}">(Destination BL No : <span style="background-color:#e9d201;color:black;">${blinfo.trkNo}</span>)</c:if>
											</th>
										</tr>
										<tr>
										...
										<tr>
											...
											<th class="left" style="background-color: white">${blinfo.Consignee}<br/>${blinfo.nativeConsignee}</th>
										</tr>
										<tr>
										...
										<c:if test="${!empty carriers}">
											<tr>
												<th class="center " style='width:120px;'>Carrier</th>
												<th class="left" style="background-color: white">${carriers.transCode}</th>
											</tr>
											<tr>
												<th class="center " style='width:120px;'>Delivery No</th>
												<th class="left" style="background-color: white">${carriers.matchNo}</th>
											</tr>
										</c:if>
										<c:if test="${blinfo.DeliveryCompany eq 'OCS' }">
											<tr>
												<th class="center " colspan="2">Duty Tax</th>
											</tr>
											<tr>
												<th class="center " style='width:120px;'>Duty Tax Amount</th>
												<th class="left" style="background-color: white">${dutyTax.dutyTaxAmount} ${dutyTax.currency}</th>
											</tr>
											<tr>
												<th class="center " style='width:120px;'>DDP Fee</th>
												<th class="left" style="background-color: white">${dutyTax.ddpFee} ${dutyTax.currency}</th>
											</tr>
											<tr>
												<th class="center " style='width:120px;'>Total Charges</th>
												<th class="left" style="background-color: white">${dutyTax.totalCharges} ${dutyTax.currency}</th>
											</tr>
										</c:if>
							...
							<c:if test="${!empty trkUrl}">
							<div style="width:100%;text-align:center;">
								<a href="${trkUrl}" target="_blank">USPS Tracking Details</a>
							</div>
							</c:if>
						</div>
					</div>
